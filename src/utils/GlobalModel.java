...
public class GlobalModel {
    ...
    public static int findintable(DefaultTableModel dtm,String keterangan, int icol) {
        int i=0;
        for (i=0;i<dtm.getRowCount()-1;i++){
            String find=GlobalUtils.churuf(dtm.getValueAt(i, icol));
            if (find.trim().equalsIgnoreCase(keterangan)){
                return i;
            }
        }
        return -1;
