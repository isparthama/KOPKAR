...
public class FrmRMKK06 extends javax.swing.JInternalFrame implements NavigatorFormInt {
    ...
    public FrmRMKK06() throws CodeException {
        initComponents();

    }
    
    public FrmRMKK06(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jHeader.setText(" : : Daftar Group Akun");
        ...
        jlblsalesman_code.setText("s/d Kode Group");
        ...
        jlblsalesman_code1.setText("Mulai Kode Group");
...
private void jbtnBrowse1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowse1ActionPerformed
    ...
    obrowse.showbrowser(obrowse.gl_group, "", jtxttosuppcode, jtxttosuppcode_desc);
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
    obrowse.showbrowser(obrowse.gl_group, "", jtxtfrsuppcode, jtxtfrsuppcode_desc);
    ...
    public void execute() throws CodeException {
        ...
        if(GlobalUtils.getAppDir()){
            try{
            file = GlobalUtils.getCurrentDir() +"/Reports/RMKK-06.jrxml";
