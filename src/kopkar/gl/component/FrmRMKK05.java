...
public class FrmRMKK05 extends javax.swing.JInternalFrame implements NavigatorFormInt {
    ...
    public FrmRMKK05() throws CodeException {
        initComponents();

    }
    
    public FrmRMKK05(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        joptstatus_aktif = new javax.swing.JRadioButton();
        joptstatus_aktif1 = new javax.swing.JRadioButton();
        joptstatus_aktif2 = new javax.swing.JRadioButton();
        ...
        jbtnBrowse2.setBounds(290, 80, 30, 17);

        jlblsalesman_code2.setFont(new java.awt.Font("Dialog", 1, 10));
        jlblsalesman_code2.setText("s/d Group Akun");
        ...
        jbtnBrowse3.setBounds(290, 100, 30, 17);

        jlblsalesman_code3.setFont(new java.awt.Font("Dialog", 1, 10));
        jlblsalesman_code3.setText("Mulai Group Akun");
        getContentPane().add(jlblsalesman_code3);
        jlblsalesman_code3.setBounds(70, 80, 140, 20);

        jtxtgroup_rek_to_desc.setFont(new java.awt.Font("Dialog", 1, 10));
        getContentPane().add(jtxtgroup_rek_to_desc);
        jtxtgroup_rek_to_desc.setBounds(330, 100, 330, 20);

        jtxtgroup_rek_fr_desc.setFont(new java.awt.Font("Dialog", 1, 10));
        getContentPane().add(jtxtgroup_rek_fr_desc);
        jtxtgroup_rek_fr_desc.setBounds(330, 80, 330, 20);

        buttonGroup1.add(joptstatus_aktif);
        joptstatus_aktif.setFont(new java.awt.Font("Dialog", 1, 10));
        joptstatus_aktif.setSelected(true);
        joptstatus_aktif.setText("Aktif");
        getContentPane().add(joptstatus_aktif);
        joptstatus_aktif.setBounds(70, 190, 123, 24);

        buttonGroup1.add(joptstatus_aktif1);
        joptstatus_aktif1.setFont(new java.awt.Font("Dialog", 1, 10));
        joptstatus_aktif1.setText("Semua");
        joptstatus_aktif1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                joptstatus_aktif1ActionPerformed(evt);
            }
        });
        getContentPane().add(joptstatus_aktif1);
        joptstatus_aktif1.setBounds(340, 190, 110, 24);

        buttonGroup1.add(joptstatus_aktif2);
        joptstatus_aktif2.setFont(new java.awt.Font("Dialog", 1, 10));
        joptstatus_aktif2.setText("Tidak Aktif");
        getContentPane().add(joptstatus_aktif2);
        joptstatus_aktif2.setBounds(200, 190, 110, 24);
...
private void jbtnBrowse1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowse1ActionPerformed
    ...
    obrowse.showbrowser(obrowse.gl_account, "", jtxttosuppcode, jtxttosuppcode_desc);
...
private void jbtnBrowse2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowse2ActionPerformed
    // TODO add your handling code here:
    obrowse.showbrowser(obrowse.gl_group, "", jtxtgroup_rek_fr, jtxtgroup_rek_fr_desc);
...
private void jbtnBrowse3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowse3ActionPerformed
    // TODO add your handling code here:
    obrowse.showbrowser(obrowse.gl_group, "", jtxtgroup_rek_to, jtxtgroup_rek_to_desc);
}//GEN-LAST:event_jbtnBrowse3ActionPerformed

private void joptstatus_aktif1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_joptstatus_aktif1ActionPerformed
    // TODO add your handling code here:
}//GEN-LAST:event_joptstatus_aktif1ActionPerformed
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
    obrowse.showbrowser(obrowse.gl_account, "", jtxtfrsuppcode, jtxtfrsuppcode_desc);
    ...
    public void execute() throws CodeException {
        ...
        parameter.put("kode_akun_fr", jtxtfrsuppcode.getText());
        parameter.put("kode_akun_to", jtxttosuppcode.getText());
        if (joptstatus_aktif.isSelected()){
            status="Y";
        } else if (joptstatus_aktif2.isSelected()){
            status="N";
        } else {
            status="";
        }
        ...
        if(GlobalUtils.getAppDir()){
            try{
            file = GlobalUtils.getCurrentDir() +"/Reports/RMKK-05.jrxml";
    ...
    private javax.swing.JRadioButton joptstatus_aktif;
    private javax.swing.JRadioButton joptstatus_aktif1;
    private javax.swing.JRadioButton joptstatus_aktif2;
