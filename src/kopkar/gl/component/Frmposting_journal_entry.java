...
import kopkar.gl.objectclasses.posting_journal_entryext;
import kopkar.gl.objectclasses.posting_journal_entryextcol;
...
public class Frmposting_journal_entry extends javax.swing.JInternalFrame implements NavigatorFormReportInt {
    ...
    String status="";
    posting_journal_entryextcol obj=new posting_journal_entryextcol();
    ...
    public Frmposting_journal_entry() throws CodeException {
        initComponents();

    }
    
    public Frmposting_journal_entry(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Posting Journal Entry");
        ...
        jHeader.setText(" : : Posting Journal Entry");
...
private void jTable1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTable1PropertyChange
    ...
    if (irow>-1){
            posting_journal_entryext o = obj.get(irow);
            o.setPilih(false);
            if (o.getJumlah()>0){
...
private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
    ...
    for (int i=0;i<model.getRowCount();i++){
        ...
        posting_journal_entryext o = obj.get(i);
        o.setPilih(false);
        if (o.getJumlah()>0){
...
private void jcmbmopItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jcmbmopItemStateChanged
        try {
            ...
            Logger.getLogger(Frmposting_journal_entry.class.getName()).log(Level.SEVERE, null, ex);
        }
...
private void formInternalFrameActivated(javax.swing.event.InternalFrameEvent evt) {                                            
    ...
    public void execute() throws CodeException {
        int ires = JOptionPane.showConfirmDialog(this, "Lakukan process Posting Journal Entry?","Posting Journal Entry Process",JOptionPane.OK_CANCEL_OPTION);
        if (ires==JOptionPane.OK_OPTION){
            posting_journal_entryext o;
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frmposting_journal_entry().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
    ...
    public void showData() throws CodeException {
        ...
        posting_journal_entryext o;
        try {
            obj=new posting_journal_entryextcol();
