...
public class FrmRTKK02 extends javax.swing.JInternalFrame implements NavigatorFormInt {
    ...
    public FrmRTKK02() throws CodeException {
        initComponents();

    }
    
    public FrmRTKK02(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jtxt_kode_gde_fr = new javax.swing.JTextField();
        jtxt_kode_gde_to = new javax.swing.JTextField();
        jbtnBrowse3 = new javax.swing.JButton();
        jlblsalesman_code5 = new javax.swing.JLabel();
        jtxt_kode_gde_fr_desc = new javax.swing.JTextField();
        jtxt_kode_gde_to_desc = new javax.swing.JTextField();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Transaksi GL Journal Entry");
        ...
        jHeader.setText(" : : Transaksi GL Journal Entry");
        ...
        jbtnBrowse.setBounds(290, 190, 30, 17);
        ...
        jbtnBrowse1.setBounds(290, 210, 30, 17);
        ...
        jlblsalesman_code1.setBounds(70, 190, 120, 20);
        ...
        jlblsalesman_code3.setBounds(70, 140, 120, 20);
        ...
        kzodocument_date_to.setBounds(190, 160, 120, 20);
        ...
        kzodocument_date_fr.setBounds(190, 140, 120, 20);
        ...
        jlblsalesman_code4.setBounds(70, 160, 120, 20);
        ...
        jbtnBrowse2.setBounds(290, 90, 30, 17);

        jlblsalesman_code2.setFont(new java.awt.Font("Dialog", 1, 10));
        jlblsalesman_code2.setText("s/d Group Data");
        getContentPane().add(jlblsalesman_code2);
        jlblsalesman_code2.setBounds(70, 110, 120, 20);

        jtxt_kode_gde_fr.setFont(new java.awt.Font("Dialog", 0, 10));
        getContentPane().add(jtxt_kode_gde_fr);
        jtxt_kode_gde_fr.setBounds(190, 90, 90, 23);

        jtxt_kode_gde_to.setFont(new java.awt.Font("Dialog", 0, 10));
        getContentPane().add(jtxt_kode_gde_to);
        jtxt_kode_gde_to.setBounds(190, 110, 90, 23);
        ...
        jbtnBrowse3.setBounds(290, 110, 30, 17);

        jlblsalesman_code5.setFont(new java.awt.Font("Dialog", 1, 10));
        jlblsalesman_code5.setText("Mulai Group Data");
        getContentPane().add(jlblsalesman_code5);
        jlblsalesman_code5.setBounds(70, 90, 120, 20);

        jtxt_kode_gde_fr_desc.setEditable(false);
        jtxt_kode_gde_fr_desc.setFont(new java.awt.Font("Dialog", 0, 10));
        getContentPane().add(jtxt_kode_gde_fr_desc);
        jtxt_kode_gde_fr_desc.setBounds(330, 90, 310, 23);

        jtxt_kode_gde_to_desc.setEditable(false);
        jtxt_kode_gde_to_desc.setFont(new java.awt.Font("Dialog", 0, 10)); // NOI18N
        getContentPane().add(jtxt_kode_gde_to_desc);
        jtxt_kode_gde_to_desc.setBounds(330, 110, 310, 23);
...
private void jbtnBrowse1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowse1ActionPerformed
    ...
    obrowse.showbrowser(obrowse.gl_transaksi_journal, "", jtxt_docnum_to);
...
private void jbtnBrowse2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowse2ActionPerformed
    // TODO add your handling code here:
    obrowse.showbrowser(obrowse.gl_group_data_entry, "", jtxt_kode_gde_fr,jtxt_kode_gde_fr_desc);
...
private void jbtnBrowse3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowse3ActionPerformed
    // TODO add your handling code here:
    obrowse.showbrowser(obrowse.gl_group_data_entry, "", jtxt_kode_gde_to,jtxt_kode_gde_to_desc);
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
    obrowse.showbrowser(obrowse.gl_transaksi_journal, "", jtxt_docnum_fr);
}                                                                                 
    ...
    public void execute() throws CodeException {
        ...
        parameter.put("kode_gde_fr", jtxt_kode_gde_fr.getText());
        parameter.put("kode_gde_to", jtxt_kode_gde_to.getText());
    ...
    private javax.swing.JTextField jtxt_kode_gde_fr;
    private javax.swing.JTextField jtxt_kode_gde_fr_desc;
    private javax.swing.JTextField jtxt_kode_gde_to;
    private javax.swing.JTextField jtxt_kode_gde_to_desc;
