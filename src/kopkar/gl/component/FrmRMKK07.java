...
public class FrmRMKK07 extends javax.swing.JInternalFrame implements NavigatorFormInt {
    ...
    public FrmRMKK07() throws CodeException {
        initComponents();

    }
    
    public FrmRMKK07(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Daftar Group Data Entry");
        ...
        jHeader.setText(" : : Daftar Group Data Entry");
        ...
        jbtnBrowse.setBounds(320, 80, 30, 17);

        jlblsalesman_code.setFont(new java.awt.Font("Dialog", 1, 10));
        jlblsalesman_code.setText("s/d Kode Group Data");
        ...
        jbtnBrowse1.setBounds(320, 100, 30, 17);

        active.setFont(new java.awt.Font("Dialog", 1, 10));
        active.setText("Tampilkan hanya Customer aktif");
        ...
        active.setBounds(220, 120, 270, 23);

        jlblsalesman_code1.setFont(new java.awt.Font("Dialog", 1, 10));
        jlblsalesman_code1.setText("Mulai Kode Group Data");
...
private void jbtnBrowse1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowse1ActionPerformed
    ...
    obrowse.showbrowser(obrowse.gl_group_data_entry, "", jtxttosuppcode, jtxttosuppcode_desc);
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
    obrowse.showbrowser(obrowse.gl_group_data_entry, "", jtxtfrsuppcode, jtxtfrsuppcode_desc);
    ...
    public void execute() throws CodeException {
        ...
        if(GlobalUtils.getAppDir()){
            try{
            file = GlobalUtils.getCurrentDir() +"/Reports/RMKK-07.jrxml";
