...
public class FrmRMKK08 extends javax.swing.JInternalFrame implements NavigatorFormReportInt {
    ...
    public FrmRMKK08() throws CodeException {
        initComponents();

    }
    
    public FrmRMKK08(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jlblsalesman_code.setText("s/d Kode RAB");
        ...
        jlblsalesman_code1.setText("Mulai Kode RAB");
...
private void jbtnBrowse1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowse1ActionPerformed
    ...
    obrowse.showbrowser(obrowse.gl_rab, "", jtxttosuppcode, jtxttosuppcode_desc);
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
    obrowse.showbrowser(obrowse.gl_rab, "", jtxtfrsuppcode, jtxtfrsuppcode_desc);
    ...
    public void execute() throws CodeException {
        ...
        if(GlobalUtils.getAppDir()){
            try{
            file = GlobalUtils.getCurrentDir() +"/Reports/RMKK-08.jrxml";
