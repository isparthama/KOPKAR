 ...
 * @author solution
 */
public class setting_financial_rpt_detail1extcol extends ArrayList<setting_financial_rpt_detail1ext> {
    setting_financial_rpt_detail1ext data=new setting_financial_rpt_detail1ext();
    String squery="";
    DbBean db=appsettinghandler.db;
    Integer id;

    public void insert(){
        data= new setting_financial_rpt_detail1ext();
    }
    public setting_financial_rpt_detail1extcol(Integer id){
        this.id=id;
    }

    public setting_financial_rpt_detail1ext getData() {
        return data;
    }

    public void setData(setting_financial_rpt_detail1ext data) {
        this.data = data;
    }
    ...
    public void initdata() throws SQLException{
        squery="call sp_setting_financial_rpt_detail1_get("+this.id+")";
    ...
    public Boolean delete(int row) {
        setting_financial_rpt_detail1ext o = this.get(row);
        try {
            return o.delete();
        } catch (CodeException ex) {
            Logger.getLogger(setting_financial_rpt_detail1extcol.class.getName()).log(Level.SEVERE, null, ex);
        }
        return false;
    }
}
