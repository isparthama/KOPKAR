/*
 * To change this in_goods_issue, choose Tools | Templates
 ...
 * @author solution
 */
public class in_goods_issueextcol extends ArrayList<in_goods_issueext> {
    in_goods_issueext data=new in_goods_issueext();
    String squery="";
    DbBean db=appsettinghandler.db;
    Integer id;

    public void insert(){
        data= new in_goods_issueext();
    }
    public in_goods_issueextcol(Integer id){
        this.id=id;
    }

    public in_goods_issueext getData() {
        return data;
    }

    public void setData(in_goods_issueext data) {
        this.data = data;
    }
    ...
    public void initdata() throws SQLException{
        squery="select * from in_goods_issue where id="+this.id;
    ...
    public Boolean delete(int row) {
        in_goods_issueext o = this.get(row);
        try {
            return o.delete();
        } catch (CodeException ex) {
            Logger.getLogger(in_goods_issueextcol.class.getName()).log(Level.SEVERE, null, ex);
        }
        return false;
    }
}
