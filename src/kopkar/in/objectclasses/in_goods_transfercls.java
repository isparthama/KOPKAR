/*
 * To change this in_goods_transfer, choose Tools | Templates
 ...
 * @author mtgmis30
 */
public class in_goods_transfercls implements Serializable {
    ...
    public String getwarehouse_code_fr() {
        return warehouse_code_fr;
    }
    public void setwarehouse_code_fr(String warehouse_code_fr) {
        this.warehouse_code_fr = warehouse_code_fr;
    }

    public String getwarehouse_code_to() {
        return warehouse_code_to;
    }
    public void setwarehouse_code_to(String warehouse_code_to) {
        this.warehouse_code_to = warehouse_code_to;
    }
