/*
 * To change this in_goods_receipt_detail1, choose Tools | Templates
 ...
 * @author solution
 */
public class in_goods_receipt_detail1extcol extends ArrayList<in_goods_receipt_detail1ext> {
    in_goods_receipt_detail1ext data=new in_goods_receipt_detail1ext();
    String squery="";
    DbBean db=appsettinghandler.db;
    Integer docentry;

    public void insert(){
        data= new in_goods_receipt_detail1ext();
    }
    public in_goods_receipt_detail1extcol(Integer docentry){
        this.docentry=docentry;
    }

    public in_goods_receipt_detail1ext getData() {
        return data;
    }

    public void setData(in_goods_receipt_detail1ext data) {
        this.data = data;
    }
    ...
    public void initdata() throws SQLException{
        squery="call sp_in_goods_receipt_detail1_get("+this.docentry+")";
    ...
    public Boolean delete(int row) {
        in_goods_receipt_detail1ext o = this.get(row);
        try {
            return o.delete();
        } catch (CodeException ex) {
            Logger.getLogger(in_goods_receipt_detail1extcol.class.getName()).log(Level.SEVERE, null, ex);
        }
        return false;
    }
}
