 ...
 * @author solution
 */
public class in_so_sheet_detail1extcol extends ArrayList<in_so_sheet_detail1ext> {
    in_so_sheet_detail1ext data=new in_so_sheet_detail1ext();
    String squery="";
    DbBean db=appsettinghandler.db;
    Integer id;

    public void insert(){
        data= new in_so_sheet_detail1ext();
    }
    public in_so_sheet_detail1extcol(Integer id){
        this.id=id;
    }

    public in_so_sheet_detail1ext getData() {
        return data;
    }

    public void setData(in_so_sheet_detail1ext data) {
        this.data = data;
    }
    ...
    public void initdata() throws SQLException{
        squery="call sp_in_so_sheet_detail1_get("+this.id+")";
    ...
    public Boolean delete(int row) {
        in_so_sheet_detail1ext o = this.get(row);
        try {
            return o.delete();
        } catch (CodeException ex) {
            Logger.getLogger(in_so_sheet_detail1extcol.class.getName()).log(Level.SEVERE, null, ex);
        }
        return false;
    }

    public boolean retrievedata(String sbrand_code_fr, String sbrand_code_to, String scategory_code_fr, String scategory_code_to, String swarehouse_code) throws SQLException {
        squery="call sp_in_so_sheet_detail1_get_new('"+sbrand_code_fr+"','"+sbrand_code_to+"','"+scategory_code_fr+"','"+scategory_code_to+"','"+swarehouse_code+"')";
        ResultSet rs = db.executeQuery(squery);
        while (rs.next()){
            data=new in_so_sheet_detail1ext();
