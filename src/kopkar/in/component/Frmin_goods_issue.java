...
import kopkar.in.objectclasses.in_goods_issue_detail1ext;
import kopkar.in.objectclasses.in_goods_issue_detail1extcol;
import kopkar.in.objectclasses.in_goods_issueext;
...
public class Frmin_goods_issue extends javax.swing.JInternalFrame implements NavigatorFormInt {
    ...
    in_goods_issueext obj=new in_goods_issueext();
    in_goods_issue_detail1extcol appods;
    browsecontroller obrowse=new browsecontroller();
    private ap_supplierext oap_supplier;

    DefaultTableModel model=null;
    private in_goods_issueext objtmp;
    private JasperReport jasperReport;
    private JasperPrint jasperPrint;
   
    /** Creates new form Area */
    public Frmin_goods_issue() throws CodeException {
        initComponents();
    }
    
    public Frmin_goods_issue(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    ...
    private void initComponents() {
        ...
        jHeader.setText(" : : Keluar Lain-lain");
...
private void jbtnBrowseDocument_NumberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowseDocument_NumberActionPerformed
    // TODO add your handling code here:
    obrowse.showbrowser(obrowse.in_goods_issue, "", jtxtdocument_number);
        try {
            ...
            Logger.getLogger(Frmin_goods_issue.class.getName()).log(Level.SEVERE, null, ex);
        }
...
private void jtbldetailKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtbldetailKeyPressed
    ...
    switch (evt.getKeyCode()){
        ...
        case KeyEvent.VK_DELETE:
            ...
            in_goods_issue_detail1ext o = appods.get(jtbldetail.getSelectedRow());
                o.setstatus(in_goods_issue_detail1ext.Status_delete);
            }
            jtbldetailPropertyChange(null);
            break;
...
private void formInternalFrameActivated(javax.swing.event.InternalFrameEvent evt) {                                            
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frmin_goods_issue().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
    ...
    public void showData() throws CodeException {
        ...
        for (i=0;i<appods.size();i++){
            in_goods_issue_detail1ext appod = appods.get(i);
    ...
    public void printData() throws CodeException {
        ...
        if(GlobalUtils.getAppDir()){
            try{
            file = GlobalUtils.getCurrentDir() +"/Reports/FTPI-05.jrxml";
    ...
    private void cekdetail() {
        ...
        in_goods_issue_detail1ext appod=new in_goods_issue_detail1ext();
        if (row > appods.size() - 1) {
            appod = new in_goods_issue_detail1ext();
            appod.setstatus(in_goods_issue_detail1ext.Status_Insert);
            appods.add(appod);
        } else {
            appod = (in_goods_issue_detail1ext) appods.get(row);
            if (!appod.getstatus().equals(in_goods_issue_detail1ext.Status_Insert)&&!appod.getstatus().equals(in_goods_issue_detail1ext.Status_delete)){
                appod.setstatus(in_goods_issue_detail1ext.Status_update);
            }
        }
