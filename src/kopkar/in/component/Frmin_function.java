...
public class Frmin_function extends javax.swing.JInternalFrame implements NavigatorFormInt {

    private static int istatus = 0;
    private static int iformtype = 0;
    public static String CLASSNAME="Frmin_function";
    
    FrmMainFrame mf ;

    in_functionext obj=new in_functionext();
   
    /** Creates new form Area */
    public Frmin_function() throws CodeException {
        initComponents();
    }
    
    public Frmin_function(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jlblfunction_name = new javax.swing.JLabel();
        jtxtfunction_name = new javax.swing.JTextField();
        ...
        getContentPane().add(jlblfunction_code);
        jlblfunction_code.setBounds(70, 100, 140, 13);

        jtxtfunction_code.setFont(new java.awt.Font("Dialog", 0, 10));
        jtxtfunction_code.setText("function_code");
        jtxtfunction_code.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                jtxtfunction_codeFocusGained(evt);
            }
        });
        getContentPane().add(jtxtfunction_code);
        jtxtfunction_code.setBounds(180, 100, 150, 23);

        jlblfunction_name.setFont(new java.awt.Font("Dialog", 1, 10));
        jlblfunction_name.setText("Keterangan");
        getContentPane().add(jlblfunction_name);
        jlblfunction_name.setBounds(70, 120, 140, 13);

        jtxtfunction_name.setFont(new java.awt.Font("Dialog", 0, 10));
        jtxtfunction_name.setText("function_name");
        jtxtfunction_name.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                jtxtfunction_nameFocusGained(evt);
            }
        });
        getContentPane().add(jtxtfunction_name);
        jtxtfunction_name.setBounds(180, 120, 420, 23);
...
private void jtxtfunction_codeFocusGained(java.awt.event.FocusEvent evt) {                                           
        // TODO add your handling code here:
    jtxtfunction_code.setSelectionStart(0);
    jtxtfunction_code.setSelectionEnd(jtxtfunction_code.getText().length());
}                                             

private void jtxtfunction_nameFocusGained(java.awt.event.FocusEvent evt) {                                           
        // TODO add your handling code here:
    jtxtfunction_name.setSelectionStart(0);
    jtxtfunction_name.setSelectionEnd(jtxtfunction_name.getText().length());
}                                             
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
    FrmBrowseData frmbrowse=new FrmBrowseData("in_function", "");
    ...
    try {
        ...
        Logger.getLogger(Frmin_function.class.getName()).log(Level.SEVERE, null, ex);
    }
}                                                                                 
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frmin_function().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
    ...
    private javax.swing.JLabel jlblfunction_name;
    ...
    private javax.swing.JTextField jtxtfunction_name;
    ...
    public void showData() throws CodeException {
        ...
        jtxtfunction_name.setText(obj.getfunction_name());
    ...
    public void setData() throws CodeException {
        ...
        obj.setfunction_name(jtxtfunction_name.getText());
