...
public class FrmRMKK09 extends javax.swing.JInternalFrame implements NavigatorFormReportInt {
    ...
    public FrmRMKK09() throws CodeException {
        initComponents();

    }
    
    public FrmRMKK09(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
    ...
    public void execute() throws CodeException {
        ...
        if(GlobalUtils.getAppDir()){
            try{
            file = GlobalUtils.getCurrentDir() +"/Reports/RMKK-09.jrxml";
