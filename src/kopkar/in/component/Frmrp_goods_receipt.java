...
public class Frmrp_goods_receipt extends javax.swing.JInternalFrame implements NavigatorFormInt {

    private static int istatus = 0;
    private static int iformtype = 0;
    public static String CLASSNAME="Frmrp_goods_receipt";
    ...
    public Frmrp_goods_receipt() throws CodeException {
        initComponents();

    }
    
    public Frmrp_goods_receipt(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Laporan Penerimaan Barang");
        ...
        jHeader.setText(" : : Laporan Penerimaan Barang");
...
private void jbtnBrowse1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowse1ActionPerformed
    ...
    obrowse.showbrowser(obrowse.in_goods_receipt, "", jtxt_docnum_to);
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
    obrowse.showbrowser(obrowse.in_goods_receipt, "", jtxt_docnum_fr);
}                                                                                 
    ...
    public void execute() throws CodeException {
        ...
        if(type.equalsIgnoreCase("0")){
            rptFile="GoodsReceipt.jrxml";
        }else if(type.equalsIgnoreCase("2")){
            rptFile="goodsreceipt_rkp_rpt.jrxml";
        }else{
            rptFile="goodsreceipt_dtl_rpt.jrxml";
        }
        if(GlobalUtils.getAppDir()){
            ...
            System.out.println("isi parameter Report GR:"+parameter);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frmrp_goods_receipt().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
