...
import kopkar.in.objectclasses.in_goods_receipt_detail1ext;
import kopkar.in.objectclasses.in_goods_receipt_detail1extcol;
import kopkar.in.objectclasses.in_goods_receiptext;
...
public class Frmin_goods_receipt extends javax.swing.JInternalFrame implements NavigatorFormInt {
    ...
    in_goods_receiptext obj=new in_goods_receiptext();
    in_goods_receipt_detail1extcol appods;
    browsecontroller obrowse=new browsecontroller();
    private ap_supplierext oap_supplier;

    DefaultTableModel model=null;
    private in_goods_receiptext objtmp;
    private JasperReport jasperReport;
    private JasperPrint jasperPrint;
   
    /** Creates new form Area */
    public Frmin_goods_receipt() throws CodeException {
        initComponents();
    }
    
    public Frmin_goods_receipt(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    ...
    private void initComponents() {
        ...
        jHeader.setText(" : : Terima Lain-lain");
...
private void jbtnBrowseDocument_NumberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowseDocument_NumberActionPerformed
    // TODO add your handling code here:
    obrowse.showbrowser(obrowse.in_goods_receipt, "", jtxtdocument_number);
        try {
            ...
            Logger.getLogger(Frmin_goods_receipt.class.getName()).log(Level.SEVERE, null, ex);
        }
...
private void jtbldetailKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtbldetailKeyPressed
    ...
    switch (evt.getKeyCode()){
        ...
        case KeyEvent.VK_DELETE:
            ...
            in_goods_receipt_detail1ext o = appods.get(jtbldetail.getSelectedRow());
                o.setstatus(in_goods_receipt_detail1ext.Status_delete);
            }
            jtbldetailPropertyChange(null);
            break;
...
private void jtbldetailPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jtbldetailPropertyChange
    ...
    if (irow>-1){
        ...
        jHeader.setText(" : : Terima Lain-lain ("+appods.size()+")");
    }
...
private void formInternalFrameActivated(javax.swing.event.InternalFrameEvent evt) {                                            
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frmin_goods_receipt().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
    ...
    public void showData() throws CodeException {
        ...
        for (i=0;i<appods.size();i++){
            in_goods_receipt_detail1ext appod = appods.get(i);
    ...
    public void printData() throws CodeException {
        ...
        if(GlobalUtils.getAppDir()){
            try{
            file = GlobalUtils.getCurrentDir() +"/Reports/FTPI-04.jrxml";
    ...
    private void cekdetail() {
        ...
        in_goods_receipt_detail1ext appod=new in_goods_receipt_detail1ext();
        if (row > appods.size() - 1) {
            appod = new in_goods_receipt_detail1ext();
            appod.setstatus(in_goods_receipt_detail1ext.Status_Insert);
            appods.add(appod);
        } else {
            appod = (in_goods_receipt_detail1ext) appods.get(row);
            if (!appod.getstatus().equals(in_goods_receipt_detail1ext.Status_Insert)&&!appod.getstatus().equals(in_goods_receipt_detail1ext.Status_delete)){
                appod.setstatus(in_goods_receipt_detail1ext.Status_update);
            }
        }
