...
public class Frmrp_warehouse extends javax.swing.JInternalFrame implements NavigatorFormInt {
    ...
    public Frmrp_warehouse() throws CodeException {
        initComponents();

    }
    
    public Frmrp_warehouse(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jlblsalesman_code.setText("s/d Kode Gudang");
        ...
        jlblsalesman_code1.setText("Mulai Kode Gudang");
...
private void jbtnBrowse1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowse1ActionPerformed
    ...
    obrowse.showbrowser(obrowse.in_warehouse, "", jtxttosuppcode, jtxttosuppcode_desc);
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
    obrowse.showbrowser(obrowse.in_warehouse, "", jtxtfrsuppcode, jtxtfrsuppcode_desc);
    ...
    public void execute() throws CodeException {
        ...
        if(GlobalUtils.getAppDir()){
            try{
            file = GlobalUtils.getCurrentDir() +"/Reports/RMKK-20.jrxml";
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frmrp_warehouse().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
