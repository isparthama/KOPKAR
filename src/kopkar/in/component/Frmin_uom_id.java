...
import kopkar.in.objectclasses.in_uom_idext;
...
public class Frmin_uom_id extends javax.swing.JInternalFrame implements NavigatorFormInt {

    private static int istatus = 0;
    private static int iformtype = 0;
    public static String CLASSNAME="Frmin_uom_id";
    
    FrmMainFrame mf ;

    in_uom_idext obj=new in_uom_idext();
   
    /** Creates new form Area */
    public Frmin_uom_id() throws CodeException {
        initComponents();
    }
    
    public Frmin_uom_id(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jlbluom_id = new javax.swing.JLabel();
        jtxtuom_id = new javax.swing.JTextField();
        ...
        jHeader.setText(" : : Unit of Measure");
        ...
        jbtnBrowse.setBounds(340, 90, 30, 17);

        jlbluom_id.setFont(new java.awt.Font("Dialog", 1, 10));
        jlbluom_id.setText("Kode UoM");
        getContentPane().add(jlbluom_id);
        jlbluom_id.setBounds(90, 90, 140, 20);

        jtxtuom_id.setFont(new java.awt.Font("Dialog", 0, 10));
        jtxtuom_id.setText("uom_id");
        jtxtuom_id.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                jtxtuom_idFocusGained(evt);
            }
        });
        getContentPane().add(jtxtuom_id);
        jtxtuom_id.setBounds(180, 90, 150, 20);

        jlbluom_desc.setFont(new java.awt.Font("Dialog", 1, 10));
        jlbluom_desc.setText("Keterangan");
        getContentPane().add(jlbluom_desc);
        jlbluom_desc.setBounds(90, 110, 140, 20);
        ...
        jtxtuom_desc.setBounds(180, 110, 370, 20);
...
private void jtxtuom_idFocusGained(java.awt.event.FocusEvent evt) {                                    
        // TODO add your handling code here:
    jtxtuom_id.setSelectionStart(0);
    jtxtuom_id.setSelectionEnd(jtxtuom_id.getText().length());
}                                      
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
    FrmBrowseData frmbrowse=new FrmBrowseData("in_uom_id", "");
    ...
    try {
        ...
        Logger.getLogger(Frmin_uom_id.class.getName()).log(Level.SEVERE, null, ex);
    }
}                                                                                 
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frmin_uom_id().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
    ...
    private javax.swing.JLabel jlbluom_id;
    ...
    private javax.swing.JTextField jtxtuom_id;
    ...
    public void showData() throws CodeException {
        ...
        jtxtuom_id.setText(obj.getuom_id());
    ...
    public void setData() throws CodeException {
        ...
        obj.setuom_id(jtxtuom_id.getText());
