/*
 * To change this ko_transaksi_lembar_tagihan_detail1, choose Tools | ko_transaksi_lembar_tagihan_detail1s
 ...
 * @author mtgmis30
 */
public class ko_transaksi_lembar_tagihan_detail1ext extends ko_transaksi_lembar_tagihan_detail1cls implements NavigatorObjectInt{
    ...
    public ko_transaksi_lembar_tagihan_detail1ext(Integer docentry) {
    ...
    public Boolean update() throws CodeException {
        ...
        if (insertsts){
            squery="call sp_ko_transaksi_lembar_tagihan_detail1_insert( "
                    + "'"+this.getdocentry()+"', "
                    + "'"+this.getlinenum()+"', "
                    + "'"+this.getyop()+"', "
                    + "'"+this.getmop()+"', "
            ...
            squery="call sp_ko_transaksi_lembar_tagihan_detail1_update( "
                    + "'"+this.getdocentry()+"', "
                    + "'"+this.getlinenum()+"', "
                    + "'"+this.getyop()+"', "
                    + "'"+this.getmop()+"', "
    ...
    public Boolean delete() throws CodeException {
        squery="call sp_ko_transaksi_lembar_tagihan_detail1_delete( "
                   + "'"+this.getdocentry()+"', "
                    + "'"+this.getlinenum()+"', "
                    + "'"+this.getyop()+"', "
                    + "'"+this.getmop()+"', "
    ...
    public Boolean initdata(Integer id) throws CodeException {
        squery="select * from ko_transaksi_lembar_tagihan_detail1 where docentry='"+id+"'";
        try {
            ...
            Logger.getLogger(ko_transaksi_lembar_tagihan_detail1ext.class.getName()).log(Level.SEVERE, null, ex);
        }
        return false;
    }

    public Boolean initdata(String docentry) throws CodeException {
        squery="CALL sp_ko_transaksi_lembar_tagihan_detail1_get('"+docentry+"', 0)";
        try {
            ResultSet rs = db.executeQuery(squery);
            while (rs.next()){
                if (fillme(rs)){
    ...
    public Boolean moveFirst() throws CodeException {
        squery="CALL sp_ko_transaksi_lembar_tagihan_detail1_get('"+this.getdocentry()+"', 1)";
        try {
            ResultSet rs = db.executeQuery(squery);
            while (rs.next()){
                if (fillme(rs)){
    ...
    public Boolean movePrevious() throws CodeException {
        squery="CALL sp_ko_transaksi_lembar_tagihan_detail1_get('"+this.getdocentry()+"', 2)";
        try {
            ResultSet rs = db.executeQuery(squery);
            while (rs.next()){
                if (fillme(rs)){
    ...
    public Boolean moveNext() throws CodeException {
        squery="CALL sp_ko_transaksi_lembar_tagihan_detail1_get('"+this.getdocentry()+"', 3)";
        try {
            ResultSet rs = db.executeQuery(squery);
            while (rs.next()){
                if (fillme(rs)){
    ...
    public Boolean moveLast() throws CodeException {
        squery="CALL sp_ko_transaksi_lembar_tagihan_detail1_get('"+this.getdocentry()+"', 4)";
        try {
            ResultSet rs = db.executeQuery(squery);
            while (rs.next()){
                if (fillme(rs)){
