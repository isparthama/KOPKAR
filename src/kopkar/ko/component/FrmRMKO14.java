...
public class FrmRMKO14 extends javax.swing.JInternalFrame implements NavigatorFormInt {
    ...
    public FrmRMKO14() throws CodeException {
        initComponents();

    }
    
    public FrmRMKO14(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }

    public FrmRMKO14(FrmMainFrame mf, String Report_Name) {
        this.mf = mf;
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Master Simpanan Potongan Anggota");
        ...
        jHeader.setText(" : : Master Simpanan Potongan Anggota");
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
    ...
    public void execute() throws CodeException {
        ...
        if(GlobalUtils.getAppDir()){
            try{
            file = GlobalUtils.getCurrentDir() +"/Reports/RMKO-05.jrxml";
