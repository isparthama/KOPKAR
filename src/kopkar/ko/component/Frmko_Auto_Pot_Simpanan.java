...
public class Frmko_Auto_Pot_Simpanan extends javax.swing.JInternalFrame implements NavigatorFormInt {
    ...
    ko_transaksi_setor_simpananext opinj;

    /** Creates new form Area */
    public Frmko_Auto_Pot_Simpanan() throws CodeException {
        initComponents();
    }
    
    public Frmko_Auto_Pot_Simpanan(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
        fillyear();
    ...
    private void initComponents() {
        ...
        setTitle("Proses Otomatis Potongan Simpanan");
        ...
        jHeader.setText(" : : Proses Otomatis Potongan Simpanan");
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
    ...
    try {
        ...
        Logger.getLogger(Frmko_Auto_Pot_Simpanan.class.getName()).log(Level.SEVERE, null, ex);
    }
}                                                                                 
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frmko_Auto_Pot_Simpanan().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
    ...
    public void saveData() throws CodeException {
        ...
        opinj=new ko_transaksi_setor_simpananext();
        if (opinj.run_sp_ko_transaksi_setor_simpanan_auto_process(jcmbTahun.getSelectedItem().toString(),GlobalUtils.churuf(jcmbBulan.getSelectedIndex()+1))){
