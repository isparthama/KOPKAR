...
public class Frmrp_pinjaman extends javax.swing.JInternalFrame implements NavigatorFormInt {

    private static int istatus = 0;
    private static int iformtype = 1;
    public static String CLASSNAME="Frmrp_pinjaman";
    ...
    public Frmrp_pinjaman() throws CodeException {
        initComponents();

    }
    
    public Frmrp_pinjaman(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jtxtkode_pinjaman_tipe_fr = new javax.swing.JTextField();
        jtxtkode_pinjaman_tipe_to = new javax.swing.JTextField();
        jbtnBrowse3 = new javax.swing.JButton();
        jlblsalesman_code3 = new javax.swing.JLabel();
        jtxtkode_pinjaman_tipe_to_desc = new javax.swing.JLabel();
        jtxtkode_pinjaman_tipe_fr_desc = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("rp_pinjaman");
        ...
        jHeader.setText(" : : Daftar Pinjaman");
        ...
        jlblsalesman_code.setText("s/d Kode Pinjaman");
        ...
        active.setText("Tampilkan hanya Pinjaman aktif");
        ...
        active.setBounds(190, 160, 270, 23);

        jlblsalesman_code1.setFont(new java.awt.Font("Dialog", 1, 10));
        jlblsalesman_code1.setText("Mulai Kode Pinjaman");
        ...
        jlblsalesman_code2.setText("s/d Tipe Pinjaman");
        getContentPane().add(jlblsalesman_code2);
        jlblsalesman_code2.setBounds(70, 100, 140, 20);

        jtxtkode_pinjaman_tipe_fr.setFont(new java.awt.Font("Dialog", 0, 10));
        getContentPane().add(jtxtkode_pinjaman_tipe_fr);
        jtxtkode_pinjaman_tipe_fr.setBounds(190, 80, 90, 23);

        jtxtkode_pinjaman_tipe_to.setFont(new java.awt.Font("Dialog", 0, 10));
        getContentPane().add(jtxtkode_pinjaman_tipe_to);
        jtxtkode_pinjaman_tipe_to.setBounds(190, 100, 90, 23);
        ...
        jlblsalesman_code3.setText("Mulai Tipe Pinjaman");
        getContentPane().add(jlblsalesman_code3);
        jlblsalesman_code3.setBounds(70, 80, 140, 20);

        jtxtkode_pinjaman_tipe_to_desc.setFont(new java.awt.Font("Dialog", 1, 10));
        getContentPane().add(jtxtkode_pinjaman_tipe_to_desc);
        jtxtkode_pinjaman_tipe_to_desc.setBounds(330, 100, 330, 20);

        jtxtkode_pinjaman_tipe_fr_desc.setFont(new java.awt.Font("Dialog", 1, 10));
        getContentPane().add(jtxtkode_pinjaman_tipe_fr_desc);
        jtxtkode_pinjaman_tipe_fr_desc.setBounds(330, 80, 330, 20);
...
private void jbtnBrowse1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowse1ActionPerformed
    ...
    obrowse.showbrowser(obrowse.ko_pinjaman, "", jtxttosuppcode, jtxttosuppcode_desc);
...
private void jbtnBrowse2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowse2ActionPerformed
    // TODO add your handling code here:
    obrowse.showbrowser(obrowse.ko_pinjaman_tipe, "", jtxtkode_pinjaman_tipe_fr, jtxtkode_pinjaman_tipe_fr_desc);
...
private void jbtnBrowse3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowse3ActionPerformed
    // TODO add your handling code here:
    obrowse.showbrowser(obrowse.ko_pinjaman_tipe, "", jtxtkode_pinjaman_tipe_to, jtxtkode_pinjaman_tipe_to_desc);
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
    obrowse.showbrowser(obrowse.ko_pinjaman, "", jtxtfrsuppcode, jtxtfrsuppcode_desc);
    ...
    public void execute() throws CodeException {
        ...
        parameter.put("kode_pinjaman_tipe_fr", jtxtkode_pinjaman_tipe_fr.getText());
        parameter.put("kode_pinjaman_tipe_to", jtxtkode_pinjaman_tipe_to.getText());
        parameter.put("kode_pinjaman_fr", jtxtfrsuppcode.getText());
        parameter.put("kode_pinjaman_to", jtxttosuppcode.getText());
        if (active.isSelected()){
            status="Y";
        }
        ...
        if(GlobalUtils.getAppDir()){
            try{
            file = GlobalUtils.getCurrentDir() +"/Reports/RMKK-26.jrxml";
            jasperReport = JasperCompileManager.compileReport(file);
            //System.out.println("file: "+file);
            System.out.println("isi parameter Daftar Pinjaman:"+parameter);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frmrp_pinjaman().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
    ...
    private javax.swing.JTextField jtxtkode_pinjaman_tipe_fr;
    private javax.swing.JLabel jtxtkode_pinjaman_tipe_fr_desc;
    private javax.swing.JTextField jtxtkode_pinjaman_tipe_to;
    private javax.swing.JLabel jtxtkode_pinjaman_tipe_to_desc;
