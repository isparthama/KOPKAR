...
public class Frmko_monthly_process extends javax.swing.JInternalFrame implements NavigatorFormInt {
    ...
    public Frmko_monthly_process() throws CodeException {
        initComponents();
    }
    
    public Frmko_monthly_process(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Proses Tagihan Potongan Simpanan dan Pinjaman");
        ...
        jHeader.setText(" : : Proses Tagihan Potongan Simpanan dan Pinjaman");
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
    ...
    try {
        ...
        Logger.getLogger(Frmko_monthly_process.class.getName()).log(Level.SEVERE, null, ex);
    }
}                                                                                 
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frmko_monthly_process().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
    ...
    public void saveData() throws CodeException {
        ...
        opinj=new ko_monthly_processext();
        if (opinj.run_sp_ko_monthly_process(jcmbTahun.getSelectedItem().toString(),GlobalUtils.churuf(jcmbBulan.getSelectedIndex()+1))){
