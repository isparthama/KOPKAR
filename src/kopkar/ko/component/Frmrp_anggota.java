...
public class Frmrp_anggota extends javax.swing.JInternalFrame implements NavigatorFormInt {

    private static int istatus = 0;
    private static int iformtype = 1;
    public static String CLASSNAME="Frmrp_anggota";
    ...
    public Frmrp_anggota() throws CodeException {
        initComponents();

    }
    
    public Frmrp_anggota(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jtxttocatcode_desc = new javax.swing.JLabel();
        jtxtfrcatcode_desc = new javax.swing.JLabel();
        ...
        jHeader.setText(" : : Daftar Anggota");
        ...
        jbtnBrowse1.setBounds(310, 120, 30, 17);

        active.setFont(new java.awt.Font("Dialog", 1, 10));
        active.setText("Tampilkan hanya Anggota aktif");
        ...
        active.setBounds(210, 70, 270, 23);
        ...
        jbtnBrowsefrbrand.setBounds(310, 150, 30, 17);

        jlblsalesman_code2.setFont(new java.awt.Font("Dialog", 1, 10));
        jlblsalesman_code2.setText("s/d Kode Departemen");
        ...
        jbtnBrowsetobrand.setBounds(310, 170, 30, 17);

        jlblsalesman_code3.setFont(new java.awt.Font("Dialog", 1, 10));
        jlblsalesman_code3.setText("Mulai Kode Departemen");
        ...
        jtxttobrandcode_desc.setBounds(350, 170, 330, 20);

        jtxtfrbrandcode_desc.setFont(new java.awt.Font("Dialog", 1, 10));
        getContentPane().add(jtxtfrbrandcode_desc);
        jtxtfrbrandcode_desc.setBounds(350, 150, 330, 20);

        jtxttocatcode_desc.setFont(new java.awt.Font("Dialog", 1, 10));
        getContentPane().add(jtxttocatcode_desc);
        jtxttocatcode_desc.setBounds(350, 210, 330, 20);

        jtxtfrcatcode_desc.setFont(new java.awt.Font("Dialog", 1, 10));
        getContentPane().add(jtxtfrcatcode_desc);
        jtxtfrcatcode_desc.setBounds(350, 190, 330, 20);
...
private void jbtnBrowsefrbrandActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowsefrbrandActionPerformed
    // TODO add your handling code here:
    obrowse.showbrowser(obrowse.ko_departemen, "", jtxtfrbrandcode, jtxtfrbrandcode_desc);
...
private void jbtnBrowsetobrandActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowsetobrandActionPerformed
    // TODO add your handling code here:
    obrowse.showbrowser(obrowse.ko_departemen, "", jtxttobrandcode, jtxttobrandcode_desc);
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
    ...
    public void execute() throws CodeException {
        ...
        parameter.put("kode_departemen_fr", jtxtfrbrandcode.getText());
        parameter.put("kode_departemen_to", jtxttobrandcode.getText());
        parameter.put("no_anggota_fr", jtxtfrsuppcode.getText());
        parameter.put("no_anggota_to", jtxttosuppcode.getText());
        if (active.isSelected()){
            status="Y";
        }
        parameter.put("aktif_sts", status);

        // Versi 1
        String file ="";
        if(GlobalUtils.getAppDir()){
            try{
            file = GlobalUtils.getCurrentDir() +"/Reports/RMKK-22.jrxml";
            jasperReport = JasperCompileManager.compileReport(file);
            //System.out.println("file: "+file);
            System.out.println("isi parameter Daftar Anggota:"+parameter);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frmrp_anggota().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
    ...
    private javax.swing.JLabel jtxtfrcatcode_desc;
    ...
    private javax.swing.JLabel jtxttocatcode_desc;
