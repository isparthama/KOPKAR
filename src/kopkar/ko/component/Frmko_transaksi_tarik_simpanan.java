/*
 * From ko_transaksi_tarik_simpanan
 *
...
import kopkar.ko.objectclasses.ko_transaksi_tarik_simpananext;
...
public class Frmko_transaksi_tarik_simpanan extends javax.swing.JInternalFrame implements NavigatorFormInt {

    private static int istatus = 0;
    private static int iformtype = 0;
    public static String CLASSNAME="Frmko_transaksi_tarik_simpanan";
    
    FrmMainFrame mf ;

    ko_transaksi_tarik_simpananext obj=new ko_transaksi_tarik_simpananext();
    private ko_anggotaext oagt;
    private browsecontroller obrowse=new browsecontroller();
    private ko_transaksi_tarik_simpananext objtmp;
   
    /** Creates new form Area */
    public Frmko_transaksi_tarik_simpanan() throws CodeException {
        initComponents();
    }
    
    public Frmko_transaksi_tarik_simpanan(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jHeader1.setText(" : : Tarik Simpanan");
...
private void jbtnBrowse_documentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowse_documentActionPerformed
    // TODO add your handling code here:
    obrowse=new browsecontroller();
    obrowse.showbrowser(obrowse.ko_transaksi_tarik_simpanan, "", jtxtdocument_number);
    if (!jtxtdocument_number.getText().equalsIgnoreCase("")){
            try {
                ...
                Logger.getLogger(Frmko_transaksi_tarik_simpanan.class.getName()).log(Level.SEVERE, null, ex);
            }
    }
...
private void formInternalFrameActivated(javax.swing.event.InternalFrameEvent evt) {                                            
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frmko_transaksi_tarik_simpanan().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
    ...
    public void newData() throws CodeException {
        istatus=1;
        objtmp=obj;
        obj=new ko_transaksi_tarik_simpananext();
        showData();
        setToolBar(iformtype,istatus);
    }
