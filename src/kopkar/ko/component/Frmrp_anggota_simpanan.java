...
public class Frmrp_anggota_simpanan extends javax.swing.JInternalFrame implements NavigatorFormInt {
    ...
    public Frmrp_anggota_simpanan() throws CodeException {
        initComponents();

    }
    
    public Frmrp_anggota_simpanan(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }

    public Frmrp_anggota_simpanan(FrmMainFrame mf, String Report_Name) {
        this.mf = mf;
        initComponents();
    ...
    private void initComponents() {
        ...
        jHeader.setText(" : : Laporan Simpanan Anggota");
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
    ...
    public void execute() throws CodeException {
        ...
        if(GlobalUtils.getAppDir()){
            try{
            file = GlobalUtils.getCurrentDir() +"/Reports/RMKO-01.jrxml";
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frmrp_anggota_simpanan().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
