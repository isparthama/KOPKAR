...
public class Frmrp_payment_term extends javax.swing.JInternalFrame implements NavigatorFormInt {

    private static int istatus = 0;
    private static int iformtype = 0;
    public static String CLASSNAME="Frmrp_payment_term";
    ...
    public Frmrp_payment_term() throws CodeException {
        initComponents();

    }
    
    public Frmrp_payment_term(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jHeader.setText(" : : Daftar Jangka Bayar");
        ...
        jlblsalesman_code.setText("s/d Kode Jangka Bayar");
        ...
        jlblsalesman_code1.setText("Mulai Kode Jangka Bayar");
...
private void jbtnBrowse1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowse1ActionPerformed
    ...
    obrowse.showbrowser(obrowse.op_payment_term, "", jtxttosuppcode, jtxttosuppcode_desc);
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
    obrowse.showbrowser(obrowse.op_payment_term, "", jtxtfrsuppcode, jtxtfrsuppcode_desc);
    ...
    public void execute() throws CodeException {
        ...
        parameter.put("paytermfr", jtxtfrsuppcode.getText());
        parameter.put("paytermto", jtxttosuppcode.getText());
        ...
        if(GlobalUtils.getAppDir()){
            try{
            file = GlobalUtils.getCurrentDir() +"/Reports/op_payment_term.jrxml";
            jasperReport = JasperCompileManager.compileReport(file);
            //System.out.println("file: "+file);
            System.out.println("isi parameter Daftar Jangka Bayar:"+parameter);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frmrp_payment_term().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
