...
public class Frmop_payment_term extends javax.swing.JInternalFrame implements NavigatorFormInt {

    private static int istatus = 0;
    private static int iformtype = 0;
    public static String CLASSNAME="Frmop_payment_term";
    
    FrmMainFrame mf ;

    op_payment_termext obj=new op_payment_termext();
   
    /** Creates new form Area */
    public Frmop_payment_term() throws CodeException {
        initComponents();
    }
    
    public Frmop_payment_term(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jlblterm_desc = new javax.swing.JLabel();
        jtxtterm_desc = new javax.swing.JTextField();
        ...
        jbtnBrowse.setBounds(290, 100, 30, 17);

        jlblterm_code.setFont(new java.awt.Font("Dialog", 1, 10));
        jlblterm_code.setText("Kode Jangka Bayar");
        getContentPane().add(jlblterm_code);
        jlblterm_code.setBounds(70, 100, 140, 13);
        ...
        jtxtterm_code.setBounds(190, 100, 90, 23);

        jlblterm_desc.setFont(new java.awt.Font("Dialog", 1, 10));
        jlblterm_desc.setText("Keterangan");
        getContentPane().add(jlblterm_desc);
        jlblterm_desc.setBounds(70, 120, 140, 13);

        jtxtterm_desc.setFont(new java.awt.Font("Dialog", 0, 10));
        jtxtterm_desc.setText("term_desc");
        jtxtterm_desc.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                jtxtterm_descFocusGained(evt);
            }
        });
        getContentPane().add(jtxtterm_desc);
        jtxtterm_desc.setBounds(190, 120, 340, 23);

        jlbldays.setFont(new java.awt.Font("Dialog", 1, 10));
        jlbldays.setText("Hari");
        getContentPane().add(jlbldays);
        jlbldays.setBounds(70, 140, 140, 13);

        jtxtdays.setFont(new java.awt.Font("Dialog", 0, 10));
        jtxtdays.setText("days");
        jtxtdays.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                jtxtdaysFocusGained(evt);
            }
        });
        getContentPane().add(jtxtdays);
        jtxtdays.setBounds(190, 140, 150, 23);
...
private void jtxtterm_descFocusGained(java.awt.event.FocusEvent evt) {                                       
        // TODO add your handling code here:
    jtxtterm_desc.setSelectionStart(0);
    jtxtterm_desc.setSelectionEnd(jtxtterm_desc.getText().length());
}                                         

private void jtxtdaysFocusGained(java.awt.event.FocusEvent evt) {                                  
        // TODO add your handling code here:
    jtxtdays.setSelectionStart(0);
    jtxtdays.setSelectionEnd(jtxtdays.getText().length());
}                                    
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
    FrmBrowseData frmbrowse=new FrmBrowseData("op_payment_term", "");
    ...
    try {
        ...
        Logger.getLogger(Frmop_payment_term.class.getName()).log(Level.SEVERE, null, ex);
    }
}                                                                                 
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frmop_payment_term().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
    ...
    private javax.swing.JLabel jlblterm_desc;
    ...
    private javax.swing.JTextField jtxtterm_desc;
    ...
    public void showData() throws CodeException {
        ...
        jtxtterm_desc.setText(obj.getterm_desc());
        jtxtdays.setText(obj.getdays().toString());
    ...
    public void setData() throws CodeException {
        ...
        obj.setterm_desc(jtxtterm_desc.getText());
        obj.setdays(Integer.parseInt(jtxtdays.getText()));
