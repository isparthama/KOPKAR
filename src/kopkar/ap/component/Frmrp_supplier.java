...
public class Frmrp_supplier extends javax.swing.JInternalFrame implements NavigatorFormInt {
    ...
    public Frmrp_supplier() throws CodeException {
        initComponents();

    }
    
    public Frmrp_supplier(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jHeader.setText(" : : Daftar Supplier");
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frmrp_supplier().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
