...
public class FrmFMAS01 extends javax.swing.JInternalFrame implements NavigatorFormInt {
    ...
    public FrmFMAS01() throws CodeException {
        initComponents();

    }
    
    public FrmFMAS01(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jtxtsaccset_kode_fr = new javax.swing.JTextField();
        jtxtsaccset_kode_to = new javax.swing.JTextField();
        jbtnBrowse1 = new javax.swing.JButton();
        jlblsalesman_code1 = new javax.swing.JLabel();
        jtxtsaccset_kode_to_desc = new javax.swing.JLabel();
        jtxtsaccset_kode_fr_desc = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Form AP Account Set");
        ...
        jHeader.setText(" : : Form AP Account Set");
        ...
        jlblsalesman_code.setText("s/d Account Set");
        getContentPane().add(jlblsalesman_code);
        jlblsalesman_code.setBounds(70, 100, 140, 20);

        jtxtsaccset_kode_fr.setFont(new java.awt.Font("Dialog", 0, 10));
        getContentPane().add(jtxtsaccset_kode_fr);
        jtxtsaccset_kode_fr.setBounds(190, 80, 90, 23);

        jtxtsaccset_kode_to.setFont(new java.awt.Font("Dialog", 0, 10));
        getContentPane().add(jtxtsaccset_kode_to);
        jtxtsaccset_kode_to.setBounds(190, 100, 90, 23);
        ...
        jlblsalesman_code1.setText("Mulai Account Set");
        getContentPane().add(jlblsalesman_code1);
        jlblsalesman_code1.setBounds(70, 80, 140, 20);

        jtxtsaccset_kode_to_desc.setFont(new java.awt.Font("Dialog", 1, 10));
        jtxtsaccset_kode_to_desc.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        getContentPane().add(jtxtsaccset_kode_to_desc);
        jtxtsaccset_kode_to_desc.setBounds(330, 100, 330, 20);

        jtxtsaccset_kode_fr_desc.setFont(new java.awt.Font("Dialog", 1, 10)); // NOI18N
        jtxtsaccset_kode_fr_desc.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        getContentPane().add(jtxtsaccset_kode_fr_desc);
        jtxtsaccset_kode_fr_desc.setBounds(330, 80, 330, 20);
...
private void jbtnBrowse1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowse1ActionPerformed
    ...
    obrowse.showbrowser(obrowse.ap_account_set, "", jtxtsaccset_kode_to, jtxtsaccset_kode_to_desc);
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
    obrowse.showbrowser(obrowse.ap_account_set, "", jtxtsaccset_kode_fr, jtxtsaccset_kode_fr_desc);
    ...
    public void execute() throws CodeException {
        ...
        parameter.put("saccset_kode_fr", jtxtsaccset_kode_fr.getText());
        parameter.put("saccset_kode_to", jtxtsaccset_kode_to.getText());
    ...
    private javax.swing.JTextField jtxtsaccset_kode_fr;
    private javax.swing.JLabel jtxtsaccset_kode_fr_desc;
    private javax.swing.JTextField jtxtsaccset_kode_to;
    private javax.swing.JLabel jtxtsaccset_kode_to_desc;
