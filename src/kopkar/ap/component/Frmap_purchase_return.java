...
import kopkar.ap.objectclasses.ap_purchase_return_detail1extcol;
...
public class Frmap_purchase_return extends javax.swing.JInternalFrame implements NavigatorFormInt {

    private static int istatus = 0;
    private static int iformtype = 0;
    public static String CLASSNAME="Frmap_purchase_return";
    
    FrmMainFrame mf ;

    ap_purchase_returnext obj=new ap_purchase_returnext();
    ap_purchase_return_detail1extcol appods;
    browsecontroller obrowse=new browsecontroller();
    private ap_supplierext oap_supplier;

    DefaultTableModel model=null;
    private ap_purchase_returnext objtmp;

    JasperPrint jasperPrint;
    JasperReport jasperReport;
   
    /** Creates new form Area */
    public Frmap_purchase_return() throws CodeException {
        initComponents();
    }
    
    public Frmap_purchase_return(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    ...
    private void initComponents() {
        ...
        jHeader.setText(" : : Retur Pembelian");
...
private void jbtnBrowseDocument_NumberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowseDocument_NumberActionPerformed
    // TODO add your handling code here:
    obrowse.showbrowser(obrowse.ap_purchase_return, "", jtxtdocument_number);
        try {
            ...
            Logger.getLogger(Frmap_purchase_return.class.getName()).log(Level.SEVERE, null, ex);
        }
...
private void jtbldetailKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtbldetailKeyPressed
    ...
    switch (evt.getKeyCode()){
        ...
        case KeyEvent.VK_DELETE:
            ...
            ap_purchase_return_detail1ext o = appods.get(jtbldetail.getSelectedRow());
                o.setstatus(ap_purchase_return_detail1ext.Status_delete);
            }
            jtbldetailPropertyChange(null);
            break;
...
private void jtbldetailPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jtbldetailPropertyChange
    ...
    if (irow>-1){
        ...
        jHeader.setText(" : : Retur Pembelian ("+appods.size()+")");
    }
...
private void formInternalFrameActivated(javax.swing.event.InternalFrameEvent evt) {                                            
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frmap_purchase_return().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
    ...
    public void showData() throws CodeException {
        ...
        for (i=0;i<appods.size();i++){
            ap_purchase_return_detail1ext appod = appods.get(i);
    ...
    public void printData() throws CodeException {
        ...
        if(GlobalUtils.getAppDir()){
            try{
            file = GlobalUtils.getCurrentDir() +"/Reports/FTPO-03.jrxml";
    ...
    private void cekdetail() {
        ...
        ap_purchase_return_detail1ext appod=new ap_purchase_return_detail1ext();
        if (row > appods.size() - 1) {
            appod = new ap_purchase_return_detail1ext();
            appod.setstatus(ap_purchase_return_detail1ext.Status_Insert);
            appods.add(appod);
        } else {
            appod = (ap_purchase_return_detail1ext) appods.get(row);
            if (!appod.getstatus().equals(ap_purchase_return_detail1ext.Status_Insert)&&!appod.getstatus().equals(ap_purchase_return_detail1ext.Status_delete)){
                appod.setstatus(ap_purchase_return_detail1ext.Status_update);
            }
        }
