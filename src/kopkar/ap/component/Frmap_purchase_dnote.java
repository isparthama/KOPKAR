...
import kopkar.ap.objectclasses.ap_purchase_dnote_detail1ext;
import kopkar.ap.objectclasses.ap_purchase_dnote_detail1extcol;
...
public class Frmap_purchase_dnote extends javax.swing.JInternalFrame implements NavigatorFormInt {

    private static int istatus = 0;
    private static int iformtype = 0;
    public static String CLASSNAME="Frmap_purchase_dnote";
    
    FrmMainFrame mf ;

    ap_purchase_dnoteext obj=new ap_purchase_dnoteext();
    ap_purchase_dnote_detail1extcol appods;
    browsecontroller obrowse=new browsecontroller();
    private ap_supplierext oap_supplier;

    DefaultTableModel model=null;
    private ap_purchase_dnoteext objtmp;
    private JasperReport jasperReport;
    private JasperPrint jasperPrint;
   
    /** Creates new form Area */
    public Frmap_purchase_dnote() throws CodeException {
        initComponents();
    }
    
    public Frmap_purchase_dnote(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
...
private void jbtnBrowseDocument_NumberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowseDocument_NumberActionPerformed
    // TODO add your handling code here:
    obrowse.showbrowser(obrowse.ap_purchase_dnote, "", jtxtdocument_number);
        try {
            ...
            Logger.getLogger(Frmap_purchase_dnote.class.getName()).log(Level.SEVERE, null, ex);
        }
...
private void jtbldetailKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtbldetailKeyPressed
    ...
    switch (evt.getKeyCode()){
        ...
        case KeyEvent.VK_DELETE:
            ...
            ap_purchase_dnote_detail1ext o = appods.get(jtbldetail.getSelectedRow());
                o.setstatus(ap_purchase_dnote_detail1ext.Status_delete);
            }
            jtbldetailPropertyChange(null);
            break;
...
private void jbtnreference_numberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnreference_numberActionPerformed
    ...
    try {
        ...
        obrowse.showbrowser(obrowse.ap_purchase_return, "document_status='O'", jtxtreference_number,obj,objref);
...
private void formInternalFrameActivated(javax.swing.event.InternalFrameEvent evt) {                                            
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frmap_purchase_dnote().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
    ...
    public void showData() throws CodeException {
        ...
        for (i=0;i<appods.size();i++){
            ap_purchase_dnote_detail1ext appod = appods.get(i);
    ...
    public void printData() throws CodeException {
        ...
        if(GlobalUtils.getAppDir()){
            try{
            file = GlobalUtils.getCurrentDir() +"/Reports/FTPI-03.jrxml";
    ...
    private void cekdetail() {
        ...
        ap_purchase_dnote_detail1ext appod=new ap_purchase_dnote_detail1ext();
        if (row > appods.size() - 1) {
            appod = new ap_purchase_dnote_detail1ext();
            appod.setstatus(ap_purchase_dnote_detail1ext.Status_Insert);
            appods.add(appod);
        } else {
            appod = (ap_purchase_dnote_detail1ext) appods.get(row);
            if (!appod.getstatus().equals(ap_purchase_dnote_detail1ext.Status_Insert)&&!appod.getstatus().equals(ap_purchase_dnote_detail1ext.Status_delete)){
                appod.setstatus(ap_purchase_dnote_detail1ext.Status_update);
            }
        }
