...
import kopkar.ap.objectclasses.ap_purchase_order_detail1extcol;
...
public class Frmap_purchase_order extends javax.swing.JInternalFrame implements NavigatorFormInt {
    ...
    ap_purchase_orderext obj=new ap_purchase_orderext();
    ap_purchase_order_detail1extcol appods;
    browsecontroller obrowse=new browsecontroller();
    private ap_supplierext oap_supplier;

    DefaultTableModel model=null;
    private ap_purchase_orderext objtmp;

    private JasperReport jasperReport;
    private JasperPrint jasperPrint;
   
    /** Creates new form Area */
    public Frmap_purchase_order() throws CodeException {
        initComponents();
    }
    
    public Frmap_purchase_order(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    ...
    private void initComponents() {
        ...
        jHeader.setText(" : : Order Pembelian");
        ...
        jtxtsupplier_code.setBounds(260, 80, 120, 23);
        ...
        jtxtsupplier_name.setBounds(260, 100, 270, 20);

        jtxtsupplier_address.setEditable(false);
        jtxtsupplier_address.setFont(new java.awt.Font("Dialog", 0, 10));
        jtxtsupplier_address.setText("jTextField1");
        getContentPane().add(jtxtsupplier_address);
        jtxtsupplier_address.setBounds(260, 120, 270, 20);
...
private void jbtnBrowseDocument_NumberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowseDocument_NumberActionPerformed
    // TODO add your handling code here:
    obrowse.showbrowser(obrowse.ap_purchase_order, "", jtxtdocument_number);
        try {
...
private void jtbldetailKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtbldetailKeyPressed
    ...
    switch (evt.getKeyCode()){
        ...
        case KeyEvent.VK_DELETE:
            ...
            ap_purchase_order_detail1ext o = appods.get(jtbldetail.getSelectedRow());
                o.setstatus(ap_purchase_order_detail1ext.Status_delete);
            }
            jtbldetailPropertyChange(null);
            break;
...
private void jbtnreference_numberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnreference_numberActionPerformed
    ...
    try {
        setData();
        ap_purchase_returnext objref=new ap_purchase_returnext();
        obrowse.showbrowser(obrowse.ap_purchase_return, "", jtxtreference_number,obj,objref);
...
private void formInternalFrameActivated(javax.swing.event.InternalFrameEvent evt) {                                            
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frmap_purchase_order().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
    ...
    public void showData() throws CodeException {
        ...
        for (i=0;i<appods.size();i++){
            ap_purchase_order_detail1ext appod = appods.get(i);
        ...
        enable_when_draft(obj.getcomplete_status().equalsIgnoreCase("N"));
    ...
    public void printData() throws CodeException {
        ...
        if(GlobalUtils.getAppDir()){
            try{
            file = GlobalUtils.getCurrentDir() +"/Reports/FTPO-01.jrxml";
    ...
    private void cekdetail() {
        ...
        ap_purchase_order_detail1ext appod=new ap_purchase_order_detail1ext();
        if (row > appods.size() - 1) {
            appod = new ap_purchase_order_detail1ext();
            appod.setstatus(ap_purchase_order_detail1ext.Status_Insert);
            appods.add(appod);
        } else {
            appod = (ap_purchase_order_detail1ext) appods.get(row);
            if (!appod.getstatus().equals(ap_purchase_order_detail1ext.Status_Insert)&&!appod.getstatus().equals(ap_purchase_order_detail1ext.Status_delete)){
                appod.setstatus(ap_purchase_order_detail1ext.Status_update);
            }
        }
    ...
    private void enable_when_draft(boolean b) {
        jbtnBrowseDocument_Number.setEnabled(b);
        jbtndiscount_code.setEnabled(b);
        jbtnprice_code.setEnabled(b);
        jbtnreference_number.setEnabled(b);
        jbtnsupplier_code.setEnabled(b);
        jbtnterm_code.setEnabled(b);
        jbtnwarehouse_code.setEnabled(b);
        jchkinclude_tax.setEnabled(b);

        jopt_complete_status_complete.setEnabled(obj.getdocument_status().equalsIgnoreCase("O"));
        jopt_complete_status_draff.setEnabled(obj.getdocument_status().equalsIgnoreCase("O"));
        //jScrollPane1 = new javax.swing.JScrollPane();
        //jtbldetail = new selectallJTable(model);
        jtxtdiscount_code.setEditable(b);
        jtxtdocument_number.setEditable(false);
        jtxtdocument_status.setEditable(false);
        jtxtdscription.setEditable(b);
        jtxtprice_code.setEditable(b);
        jtxtreference.setEditable(b);
        jtxtreference_number.setEditable(b);
        jtxtsupplier_address.setEditable(false);
        jtxtsupplier_code.setEditable(b);
        jtxtsupplier_name.setEditable(false);
        jtxtTanggalEntry.setEditable(false);
        jtxtTanggalUpdate.setEditable(false);
        jtxttax_amount.setEditable(false);
        jtxttax_percent.setEditable(false);
        jtxtterm_code.setEditable(b);
        jtxttotal_aft_discount.setEditable(false);
        jtxttotal_aft_tax.setEditable(false);
        jtxttotal_bfr_discount.setEditable(false);
        jtxttotal_discount.setEditable(false);
        jtxtUserID.setEditable(false);
        jtxtwarehouse_code.setEditable(b);
        kzodocument_date.setEditable(b);
        kzodocument_duedate.setEditable(b);
