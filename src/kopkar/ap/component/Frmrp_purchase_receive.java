...
public class Frmrp_purchase_receive extends javax.swing.JInternalFrame implements NavigatorFormInt {

    private static int istatus = 0;
    private static int iformtype = 0;
    public static String CLASSNAME="Frmrp_purchase_receive";
    ...
    public Frmrp_purchase_receive() throws CodeException {
        initComponents();

    }
    
    public Frmrp_purchase_receive(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Laporan Penerimaan Pembelian");
        ...
        jHeader.setText(" : : Laporan Penerimaan Pembelian");
...
private void jbtnBrowse1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowse1ActionPerformed
    ...
    obrowse.showbrowser(obrowse.ap_purchase_receive, "", jtxt_docnum_to);
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
    obrowse.showbrowser(obrowse.ap_purchase_receive, "", jtxt_docnum_fr);
}                                                                                 
    ...
    public void execute() throws CodeException {
        ...
        if(type.equalsIgnoreCase("0")){
            rptFile="PurchaseReceive.jrxml";
        }else if(type.equalsIgnoreCase("2")){
            rptFile="purchasereceive_rkp_rpt.jrxml";
        }else{
            rptFile="purchasereceive_dtl_rpt.jrxml";
        }
        if(GlobalUtils.getAppDir()){
            ...
            System.out.println("isi parameter Report PR:"+parameter);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frmrp_purchase_receive().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
