...
public class Frmrp_supplier_analisa extends javax.swing.JInternalFrame implements NavigatorFormInt {
    ...
    public Frmrp_supplier_analisa() throws CodeException {
        initComponents();

    }
    
    public Frmrp_supplier_analisa(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jtxtfrproduct = new javax.swing.JTextField();
        jlblsalesman_code2 = new javax.swing.JLabel();
        jtxtfrproductdes = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Daftar Supplier Analisa");
        ...
        jHeader.setText(" : : Daftar Supplier Analisa");
        ...
        jlblsalesman_code.setText("s/d Kode Supplier");
        ...
        active.setBounds(190, 120, 270, 23);

        jlblsalesman_code1.setFont(new java.awt.Font("Dialog", 1, 10));
        jlblsalesman_code1.setText("Mulai Kode Supplier");
        ...
        jtxtfrproduct.setFont(new java.awt.Font("Dialog", 0, 10));
        getContentPane().add(jtxtfrproduct);
        jtxtfrproduct.setBounds(190, 150, 90, 20);

        jlblsalesman_code2.setFont(new java.awt.Font("Dialog", 1, 10));
        jlblsalesman_code2.setText("Product");
        getContentPane().add(jlblsalesman_code2);
        jlblsalesman_code2.setBounds(70, 150, 140, 20);

        jtxtfrproductdes.setFont(new java.awt.Font("Dialog", 1, 10));
        getContentPane().add(jtxtfrproductdes);
        jtxtfrproductdes.setBounds(330, 150, 330, 20);
...
private void jbtnBrowse1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowse1ActionPerformed
    ...
    obrowse.showbrowser(obrowse.ap_supplier, "", jtxttosuppcode, jtxttosuppcode_desc);
...
private void jbtnBrowse2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowse2ActionPerformed
    // TODO add your handling code here:
    obrowse.showbrowser(obrowse.in_product, "", jtxtfrproduct, jtxtfrproductdes);
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
    obrowse.showbrowser(obrowse.ap_supplier, "", jtxtfrsuppcode, jtxtfrsuppcode_desc);
    ...
    public void execute() throws CodeException {
        ...
        parameter.put("customer_code_fr", jtxtfrsuppcode.getText());
        parameter.put("customer_code_to", jtxttosuppcode.getText());
        ...
        if(GlobalUtils.getAppDir()){
            try{
            file = GlobalUtils.getCurrentDir() +"/Reports/RMKK-01.jrxml";
            jasperReport = JasperCompileManager.compileReport(file);
            //System.out.println("file: "+file);
            System.out.println("isi parameter Daftar Supplier:"+parameter);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frmrp_supplier_analisa().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
    ...
    private javax.swing.JTextField jtxtfrproduct;
    private javax.swing.JLabel jtxtfrproductdes;
