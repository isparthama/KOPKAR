...
public class Frmrp_purchase_return extends javax.swing.JInternalFrame implements NavigatorFormInt {

    private static int istatus = 0;
    private static int iformtype = 0;
    public static String CLASSNAME="Frmrp_purchase_retur";
    ...
    public Frmrp_purchase_return() throws CodeException {
        initComponents();

    }
    
    public Frmrp_purchase_return(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Laporan Permintaan Pembelian");
        ...
        jHeader.setText(" : : Laporan Permintaan Pembelian");
...
private void jbtnBrowse1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowse1ActionPerformed
    ...
    obrowse.showbrowser(obrowse.ap_purchase_return, "", jtxt_docnum_to);
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
    obrowse.showbrowser(obrowse.ap_purchase_return, "", jtxt_docnum_fr);
}                                                                                 
    ...
    public void execute() throws CodeException {
        ...
        if(type.equalsIgnoreCase("0")){
            rptFile="PurchaseRetur.jrxml";
        }else if(type.equalsIgnoreCase("2")){
            rptFile="purchaseretur_rkp_rpt.jrxml";
        }else{
            rptFile="purchaseretur_dtl_rpt.jrxml";
        }
        if(GlobalUtils.getAppDir()){
            ...
            System.out.println("isi parameter Report PRet:"+parameter);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frmrp_purchase_return().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
