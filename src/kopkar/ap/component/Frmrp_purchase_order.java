...
public class Frmrp_purchase_order extends javax.swing.JInternalFrame implements NavigatorFormInt {
    ...
    public Frmrp_purchase_order() throws CodeException {
        initComponents();

    }
    
    public Frmrp_purchase_order(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }
...
private void jbtnBrowse1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowse1ActionPerformed
    ...
    obrowse.showbrowser(obrowse.ap_purchase_order, "", jtxt_docnum_to);
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
    obrowse.showbrowser(obrowse.ap_purchase_order, "", jtxt_docnum_fr);
}                                                                                 
    ...
    public void execute() throws CodeException {
        ...
        if(type.equalsIgnoreCase("0")){
            rptFile="PurchaseOrder.jrxml";
        }else if(type.equalsIgnoreCase("2")){
            rptFile="purchaseorder_rkp_rpt.jrxml";
        }else{
            rptFile="purchaseorder_dtl_rpt.jrxml";
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frmrp_purchase_order().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
