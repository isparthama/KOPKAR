/*
 * To change this ap_purchase_dnote_detail1, choose Tools | Templates
 ...
 * @author solution
 */
public class ap_purchase_dnote_detail1extcol extends ArrayList<ap_purchase_dnote_detail1ext> {
    ap_purchase_dnote_detail1ext data=new ap_purchase_dnote_detail1ext();
    String squery="";
    DbBean db=appsettinghandler.db;
    Integer docentry;

    public void insert(){
        data= new ap_purchase_dnote_detail1ext();
    }
    public ap_purchase_dnote_detail1extcol(Integer docentry){
        this.docentry=docentry;
    }

    public ap_purchase_dnote_detail1ext getData() {
        return data;
    }

    public void setData(ap_purchase_dnote_detail1ext data) {
        this.data = data;
    }
    ...
    public void initdata() throws SQLException{
        squery="call sp_ap_purchase_dnote_detail1_get("+this.docentry+")";
    ...
    public Boolean delete(int row) {
        ap_purchase_dnote_detail1ext o = this.get(row);
        try {
            return o.delete();
        } catch (CodeException ex) {
            Logger.getLogger(ap_purchase_dnote_detail1extcol.class.getName()).log(Level.SEVERE, null, ex);
        }
        return false;
    }
}
