/*
 * To change this ap_purchase_order, choose Tools | Templates
 ...
 * @author solution
 */
public class ap_purchase_orderextcol extends ArrayList<ap_purchase_orderext> {
    ap_purchase_orderext data=new ap_purchase_orderext();
    String squery="";
    DbBean db=appsettinghandler.db;
    Integer id;

    public void insert(){
        data= new ap_purchase_orderext();
    }
    public ap_purchase_orderextcol(Integer id){
        this.id=id;
    }

    public ap_purchase_orderext getData() {
        return data;
    }

    public void setData(ap_purchase_orderext data) {
        this.data = data;
    }
    ...
    public void initdata() throws SQLException{
        squery="select * from ap_purchase_order where id="+this.id;
    ...
    public Boolean delete(int row) {
        ap_purchase_orderext o = this.get(row);
        try {
            return o.delete();
        } catch (CodeException ex) {
            Logger.getLogger(ap_purchase_orderextcol.class.getName()).log(Level.SEVERE, null, ex);
        }
        return false;
    }
}
