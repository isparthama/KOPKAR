...
public class FrmRMKK04 extends javax.swing.JInternalFrame implements NavigatorFormInt {
    ...
    public FrmRMKK04() throws CodeException {
        initComponents();

    }
    
    public FrmRMKK04(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }
...
private void jbtnBrowse1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowse1ActionPerformed
    ...
    obrowse.showbrowser(obrowse.ar_pos_counter, "", jtxttosuppcode, jtxttosuppcode_desc);
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
    obrowse.showbrowser(obrowse.ar_pos_counter, "", jtxtfrsuppcode, jtxtfrsuppcode_desc);
    ...
    public void execute() throws CodeException {
        ...
        if(GlobalUtils.getAppDir()){
            try{
            file = GlobalUtils.getCurrentDir() +"/Reports/RMKK-04.jrxml";
