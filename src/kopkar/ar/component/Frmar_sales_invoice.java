...
import kopkar.ar.objectclasses.ar_sales_invoice_detail1ext;
import kopkar.ar.objectclasses.ar_sales_invoice_detail1extcol;
...
public class Frmar_sales_invoice extends javax.swing.JInternalFrame implements NavigatorFormInt {

    private static int istatus = 0;
    private static int iformtype = 0;
    public static String CLASSNAME="Frmar_sales_invoice";
    
    FrmMainFrame mf ;

    ar_sales_invoiceext obj=new ar_sales_invoiceext();
    ar_sales_invoice_detail1extcol appods;
    browsecontroller obrowse=new browsecontroller();
    private ar_customerext oar_customer;

    DefaultTableModel model=null;
    private ar_sales_invoiceext objtmp;
    private JasperReport jasperReport;
    private JasperPrint jasperPrint;
   
    /** Creates new form Area */
    public Frmar_sales_invoice() throws CodeException {
        initComponents();
    }
    
    public Frmar_sales_invoice(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
...
private void jbtnBrowseDocument_NumberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowseDocument_NumberActionPerformed
    // TODO add your handling code here:
    obrowse.showbrowser(obrowse.ar_sales_invoice, "", jtxtdocument_number);
        try {
            ...
            Logger.getLogger(Frmar_sales_invoice.class.getName()).log(Level.SEVERE, null, ex);
        }
...
private void jtbldetailKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtbldetailKeyPressed
    ...
    switch (evt.getKeyCode()){
        ...
        case KeyEvent.VK_DELETE:
            ...
            ar_sales_invoice_detail1ext o = appods.get(jtbldetail.getSelectedRow());
                o.setstatus(ar_sales_invoice_detail1ext.Status_delete);
            }
            jtbldetailPropertyChange(null);
            break;
...
private void formInternalFrameActivated(javax.swing.event.InternalFrameEvent evt) {                                            
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frmar_sales_invoice().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
    ...
    public void showData() throws CodeException {
        ...
        for (i=0;i<appods.size();i++){
            ar_sales_invoice_detail1ext appod = appods.get(i);
    ...
    public void printData() throws CodeException {
        ...
        if(GlobalUtils.getAppDir()){
            try{
            file = GlobalUtils.getCurrentDir() +"/Reports/FTSI-04.jrxml";
    ...
    private void cekdetail() {
        ...
        ar_sales_invoice_detail1ext appod=new ar_sales_invoice_detail1ext();
        if (row > appods.size() - 1) {
            appod = new ar_sales_invoice_detail1ext();
            appod.setstatus(ar_sales_invoice_detail1ext.Status_Insert);
            appods.add(appod);
        } else {
            appod = (ar_sales_invoice_detail1ext) appods.get(row);
            if (!appod.getstatus().equals(ar_sales_invoice_detail1ext.Status_Insert)&&!appod.getstatus().equals(ar_sales_invoice_detail1ext.Status_delete)){
                appod.setstatus(ar_sales_invoice_detail1ext.Status_update);
            }
        }
