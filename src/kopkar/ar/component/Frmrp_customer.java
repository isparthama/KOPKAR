...
public class Frmrp_customer extends javax.swing.JInternalFrame implements NavigatorFormInt {
    ...
    public Frmrp_customer() throws CodeException {
        initComponents();

    }
    
    public Frmrp_customer(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jHeader.setText(" : : Daftar Customer");
        ...
        jlblsalesman_code.setText("s/d Kode Customer");
        ...
        jlblsalesman_code1.setText("Mulai Kode Customer");
...
private void jbtnBrowse1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowse1ActionPerformed
    ...
    obrowse.showbrowser(obrowse.ar_customer, "", jtxttosuppcode, jtxttosuppcode_desc);
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
    obrowse.showbrowser(obrowse.ar_customer, "", jtxtfrsuppcode, jtxtfrsuppcode_desc);
    ...
    public void execute() throws CodeException {
        ...
        if(GlobalUtils.getAppDir()){
            try{
            file = GlobalUtils.getCurrentDir() +"/Reports/RMKK-02.jrxml";
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frmrp_customer().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
