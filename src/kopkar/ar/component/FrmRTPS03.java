...
public class FrmRTPS03 extends javax.swing.JInternalFrame implements NavigatorFormInt {
    ...
    public FrmRTPS03() throws CodeException {
        initComponents();

    }
    
    public FrmRTPS03(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jopttipe_bayar_potong = new javax.swing.JRadioButton();
        jopttipe_bayar_semua = new javax.swing.JRadioButton();
        jopttipe_bayar_tunai = new javax.swing.JRadioButton();
        ...
        jchckroup_by_chashier_sts = new javax.swing.JCheckBox();
        ...
        jHeader.setText(" : : Pos Sales Report");
        ...
        buttonGroup1.add(jopttipe_bayar_potong);
        jopttipe_bayar_potong.setFont(new java.awt.Font("Dialog", 1, 10));
        jopttipe_bayar_potong.setText("Potong Gaji");
        jopttipe_bayar_potong.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jopttipe_bayar_potongActionPerformed(evt);
            }
        });
        getContentPane().add(jopttipe_bayar_potong);
        jopttipe_bayar_potong.setBounds(500, 300, 114, 23);

        buttonGroup1.add(jopttipe_bayar_semua);
        jopttipe_bayar_semua.setFont(new java.awt.Font("Dialog", 1, 10));
        jopttipe_bayar_semua.setSelected(true);
        jopttipe_bayar_semua.setText("Semua");
        jopttipe_bayar_semua.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jopttipe_bayar_semuaActionPerformed(evt);
            }
        });
        getContentPane().add(jopttipe_bayar_semua);
        jopttipe_bayar_semua.setBounds(190, 300, 67, 29);

        buttonGroup1.add(jopttipe_bayar_tunai);
        jopttipe_bayar_tunai.setFont(new java.awt.Font("Dialog", 1, 10));
        jopttipe_bayar_tunai.setText("Tunai");
        jopttipe_bayar_tunai.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jopttipe_bayar_tunaiActionPerformed(evt);
            }
        });
        getContentPane().add(jopttipe_bayar_tunai);
        jopttipe_bayar_tunai.setBounds(320, 300, 60, 23);

        jlblsalesman_code5.setFont(new java.awt.Font("Dialog", 1, 10));
        jlblsalesman_code5.setText("Type Bayar");
        getContentPane().add(jlblsalesman_code5);
        jlblsalesman_code5.setBounds(70, 300, 120, 20);

        buttonGroup2.add(joptsort_by_tanggal);
        joptsort_by_tanggal.setFont(new java.awt.Font("Dialog", 1, 10));
        ...
        joptsort_by_type.setFont(new java.awt.Font("Dialog", 1, 10));
        ...
        jtxtcustomer_code_fr.setFont(new java.awt.Font("Dialog", 0, 10));
        jPanel2.add(jtxtcustomer_code_fr);
        jtxtcustomer_code_fr.setBounds(150, 40, 90, 20);

        jtxtcustomer_code_to.setFont(new java.awt.Font("Dialog", 0, 10));
        jPanel2.add(jtxtcustomer_code_to);
        jtxtcustomer_code_to.setBounds(150, 60, 90, 20);
        ...
        jtxtcustomer_code_to_desc.setFont(new java.awt.Font("Dialog", 0, 10));
        jPanel2.add(jtxtcustomer_code_to_desc);
        jtxtcustomer_code_to_desc.setBounds(290, 60, 390, 20);

        jtxtcustomer_code_fr_desc.setEditable(false);
        jtxtcustomer_code_fr_desc.setFont(new java.awt.Font("Dialog", 0, 10));
        jPanel2.add(jtxtcustomer_code_fr_desc);
        jtxtcustomer_code_fr_desc.setBounds(290, 40, 390, 20);
        ...
        type_summary1.setFont(new java.awt.Font("Dialog", 1, 10));
        ...
        type_detail1.setFont(new java.awt.Font("Dialog", 1, 10));
        ...
        jchckroup_by_chashier_sts.setFont(new java.awt.Font("Dialog", 1, 10));
        jchckroup_by_chashier_sts.setText("Group by cashier");
        getContentPane().add(jchckroup_by_chashier_sts);
        jchckroup_by_chashier_sts.setBounds(70, 360, 200, 29);

        buttonGroup2.add(joptsort_by_customer);
        joptsort_by_customer.setFont(new java.awt.Font("Dialog", 1, 10));
...
private void jopttipe_bayar_semuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jopttipe_bayar_semuaActionPerformed
    // TODO add your handling code here:
    if(jopttipe_bayar_semua.isSelected()){
        status="A";
    }
}//GEN-LAST:event_jopttipe_bayar_semuaActionPerformed

private void jopttipe_bayar_tunaiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jopttipe_bayar_tunaiActionPerformed
    // TODO add your handling code here:
    if(jopttipe_bayar_tunai.isSelected()){
        status="O";
    }
}//GEN-LAST:event_jopttipe_bayar_tunaiActionPerformed

private void jopttipe_bayar_potongActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jopttipe_bayar_potongActionPerformed
    // TODO add your handling code here:
    if(jopttipe_bayar_potong.isSelected()){
        status="C";
    }
}//GEN-LAST:event_jopttipe_bayar_potongActionPerformed
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
    ...
    public void execute() throws CodeException {
        ...
        String group_by_chashier_sts="N";
        if (jchckroup_by_chashier_sts.isSelected()){
            group_by_chashier_sts="Y";
        }
        parameter.put("group_by_chashier_sts", group_by_chashier_sts);
        String tipe_bayar="A";
        if (jopttipe_bayar_potong.isSelected()){
            tipe_bayar="Y";
        }
        ...
        parameter.put("tipe_bayar", tipe_bayar);
        String sort_by="1";
        ...
        if(type_summary1.isSelected()){
            rptFile="RTPS-04.jrxml";
        }else{
            rptFile="RTPS-03.jrxml";
        }
    ...
    private javax.swing.JCheckBox jchckroup_by_chashier_sts;
    ...
    private javax.swing.JRadioButton jopttipe_bayar_potong;
    private javax.swing.JRadioButton jopttipe_bayar_semua;
    private javax.swing.JRadioButton jopttipe_bayar_tunai;
