...
public class FrmRMKK03 extends javax.swing.JInternalFrame implements NavigatorFormInt {
    ...
    public FrmRMKK03() throws CodeException {
        initComponents();

    }
    
    public FrmRMKK03(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jlblsalesman_code.setText("s/d Kode Kasir");
        ...
        jlblsalesman_code1.setText("Mulai Kode Kasir");
...
private void jbtnBrowse1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowse1ActionPerformed
    ...
    obrowse.showbrowser(obrowse.ar_pos_chasier, "", jtxttosuppcode, jtxttosuppcode_desc);
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
    obrowse.showbrowser(obrowse.ar_pos_chasier, "", jtxtfrsuppcode, jtxtfrsuppcode_desc);
    ...
    public void execute() throws CodeException {
        ...
        if(GlobalUtils.getAppDir()){
            try{
            file = GlobalUtils.getCurrentDir() +"/Reports/RMKK-03.jrxml";
