...
public class Frmrp_salesman extends javax.swing.JInternalFrame implements NavigatorFormInt {

    private static int istatus = 0;
    private static int iformtype = 0;
    public static String CLASSNAME="Frmrp_salesman";
    ...
    public Frmrp_salesman() throws CodeException {
        initComponents();

    }
    
    public Frmrp_salesman(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jHeader.setText(" : : Daftar Salesman");
        ...
        jlblsalesman_code.setText("s/d Kode Sales");
        ...
        jlblsalesman_code1.setText("Mulai Kode Sales");
...
private void jbtnBrowse1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowse1ActionPerformed
    ...
    obrowse.showbrowser(obrowse.op_salesman, "", jtxttosuppcode, jtxttosuppcode_desc);
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
    obrowse.showbrowser(obrowse.op_salesman, "", jtxtfrsuppcode, jtxtfrsuppcode_desc);
    ...
    public void execute() throws CodeException {
        ...
        parameter.put("salesmanfr", jtxtfrsuppcode.getText());
        parameter.put("salesmanto", jtxttosuppcode.getText());
        ...
        if(GlobalUtils.getAppDir()){
            try{
            file = GlobalUtils.getCurrentDir() +"/Reports/op_salesman.jrxml";
            jasperReport = JasperCompileManager.compileReport(file);
            //System.out.println("file: "+file);
            System.out.println("isi parameter Daftar Salesman:"+parameter);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frmrp_salesman().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
