...
import kopkar.ar.objectclasses.ar_pos_sales_detail1extcol;
...
import kopkar.in.objectclasses.in_productcls;
...
public class Frmar_pos_sales extends javax.swing.JInternalFrame implements NavigatorFormInt {
    ...
    public static String CLASSNAME="Frmar_pos_sales";
    
    FrmMainFrame mf ;

    ar_pos_salesext obj=new ar_pos_salesext();
    ar_pos_sales_detail1extcol appods;
    browsecontroller obrowse=new browsecontroller();
    private ar_customerext oar_customer;

    DefaultTableModel model=null;
    private ar_pos_salesext objtmp;
    private in_product_findcls oin_product;
    private HashMap parameter;
    private JasperReport jasperReport;
    private JasperPrint jasperPrint;
    private ar_pos_optionext oar_opt;
   
    /** Creates new form Area */
    public Frmar_pos_sales() throws CodeException {
        initComponents();
    }
    
    public Frmar_pos_sales(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    ...
    private void initComponents() {
        ...
        jHeader.setBounds(10, 30, 200, 20);
        ...
        jbtnBrowseDocument_Number.setBounds(970, 80, 30, 17);
        ...
        jlbldocument_number.setBounds(630, 80, 140, 13);
        ...
        jtxtdocument_number.setBounds(820, 80, 150, 23);
        ...
        jlbldocument_status.setBounds(630, 60, 140, 13);
        ...
        jtxtdocument_status.setBounds(820, 60, 150, 23);
        ...
        jlbldocument_date.setBounds(630, 100, 140, 13);
        ...
        jlbldocument_duedate.setBounds(630, 120, 140, 13);
        ...
        jtxtchasier_code.setBounds(200, 460, 70, 23);
        ...
        jtxtchasier_name.setBounds(270, 460, 180, 23);
        ...
        jtxtjumlah_item.setBounds(460, 460, 150, 70);
        ...
        jtxttotal_aft_tax.setBounds(610, 460, 370, 70);
        ...
        jtxtTanggalEntry.setBounds(560, 30, 170, 20);
        ...
        jtxtTanggalUpdate.setBounds(730, 30, 130, 20);
        ...
        jtxtUserID.setBounds(860, 30, 140, 20);
        ...
        jlblsupplier_code2.setBounds(590, 170, 140, 13);
        ...
        jbtnsupplier_code.setBounds(880, 150, 30, 17);
        ...
        jtxtcustomer_name.setBounds(730, 170, 270, 20);
        ...
        kzodocument_date.setBounds(820, 100, 100, 20);
        ...
        jScrollPane1.setBounds(10, 200, 990, 250);
        ...
        jtxtfaktur_sebelum_no.setBounds(200, 480, 150, 23);
        ...
        jtxtfaktur_sebelum_amount.setBounds(200, 500, 150, 23);
        ...
        jTextField1.setBounds(10, 150, 520, 50);
        ...
        jlblsupplier_code3.setBounds(590, 150, 140, 13);
        ...
        jComboBox1.setBounds(180, 130, 150, 20);
        ...
        jlblsupplier_code4.setBounds(10, 130, 140, 13);
        ...
        jlblsupplier_code5.setBounds(10, 60, 140, 15);
        ...
        jlblsupplier_code6.setBounds(10, 80, 140, 13);
        ...
        jlblsupplier_code7.setBounds(10, 100, 260, 13);
        ...
        jlbldscription2.setBounds(10, 500, 180, 13);
...
private void jbtnBrowseDocument_NumberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnBrowseDocument_NumberActionPerformed
    ...
    obrowse.showbrowser(obrowse.ar_pos_sales, "", jtxtdocument_number);
        try {
            ...
            Logger.getLogger(Frmar_pos_sales.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    switch (evt.getKeyCode()){
        ...
        case KeyEvent.VK_DELETE:
            ...
            if (jtbldetail.getSelectedRow()<appods.size()){
                ar_pos_sales_detail1ext o = appods.get(jtbldetail.getSelectedRow());
...
private void formInternalFrameActivated(javax.swing.event.InternalFrameEvent evt) {                                            
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frmar_pos_sales().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
    ...
    private void clearfield(){
        ...
        jtxtchasier_code.setText(GlobalUtils.userid);
        jtxtchasier_name.setText(GlobalUtils.audituser);
    ...
    public void newData() throws CodeException {
        ...
        istatus=1;
        objtmp=obj;
        obj=new ar_pos_salesext();

        showData();

        oar_opt=new ar_pos_optionext();
        ...
        ar_pos_chasierext apc=new ar_pos_chasierext();
        if (apc.initdata_by_user_code(GlobalUtils.userid)){
            jtxtchasier_code.setText(apc.getchasier_code());
            jtxtchasier_name.setText(apc.getchasier_name());
        }
    ...
    public void showData() throws CodeException {
        ...
        if (oar_opt.moveFirst()){
            obj.setmodel_struk(oar_opt.getmodel_struk());
            obj.setprint_to_printer(oar_opt.getprint_to_printer());
        }
        ...
        for (i=0;i<appods.size();i++){
            ar_pos_sales_detail1ext appod = appods.get(i);
    ...
    public void setData() throws CodeException {
        ...
        obj.setcounter_number(appsettinghandler.getCounter());
    ...
    private void showdatacustomer() {
        ...
        try {
            if (oar_customer.run_sp_ar_customer_get_find(jtxtcustomer_code.getText())){
                obj.setcustomer_info(oar_customer);
    ...
    private Boolean showproduct(Integer ishowproduct,Integer irow) {
        ...
        if (oin_product.initdata(sproduct_code,suom_id,scost_price_code,ssales_price_code)) {
            if (ishowproduct==product_show_validate){
                ...
                in_productextcol o_child=new in_productextcol();
                try {
                    o_child.initdata_by_parent_code(oin_product.getProduct_code());
                    for (int i=0;i<o_child.size();i++){
                        oc=o_child.get(i);
                        oin_product.initdata(oc.getproduct_code(),suom_id,scost_price_code,ssales_price_code);
                        model.addRow(new Object[model.getRowCount()-1]);
                        model.setValueAt(model.getRowCount(), model.getRowCount()-1, 0);
                        model.setValueAt(oin_product.getProduct_code(), model.getRowCount()-1, 1);
                        model.setValueAt(oin_product.getProduct_name(), model.getRowCount()-1, 2);
                        model.setValueAt(1, model.getRowCount()-1, 4);
                        model.setValueAt(oin_product.getUom_code(), model.getRowCount()-1, 5);
                        model.setValueAt(oin_product.getPrice(), model.getRowCount()-1, 6);
                        model.setValueAt(oin_product.getPrice(), model.getRowCount()-1, 7);
                        model.setValueAt(0, model.getRowCount()-1, 8);
                        model.setValueAt(oin_product.getUom(), model.getRowCount()-1, 10);
                        switch (oin_product.getUom_id()){
                            case 1:
                            suom_desc="Pieces";
                            break;
                        ...
                        cekdetail(model.getRowCount()-1,0);
                        model.setValueAt(suom_desc, model.getRowCount()-1, 3);
                    }
    ...
    private void cekdetail(int row,int col) {
        ar_pos_sales_detail1ext appod=new ar_pos_sales_detail1ext();
        if (row > appods.size() - 1) {
            appod = new ar_pos_sales_detail1ext();
            appod.setstatus(ar_pos_sales_detail1ext.Status_Insert);
            appods.add(appod);
        } else {
            appod = (ar_pos_sales_detail1ext) appods.get(row);
            if (!appod.getstatus().equals(ar_pos_sales_detail1ext.Status_Insert)&&!appod.getstatus().equals(ar_pos_sales_detail1ext.Status_delete)){
                appod.setstatus(ar_pos_sales_detail1ext.Status_update);
            }
        }
        ...
        try {
            switch (evt.getKeyCode()){
                ...
                case KeyEvent.VK_F12:
                    frmar_pos_sales_payment opayment=new frmar_pos_sales_payment(obj,this);
    ...
    private int isproductexists(String kode_produk) {
        for (int i=0;i<appods.size();i++){
            ar_pos_sales_detail1ext o = appods.get(i);
