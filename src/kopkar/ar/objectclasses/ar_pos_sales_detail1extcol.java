/*
 * To change this ar_pos_sales_detail1, choose Tools | Templates
 ...
 * @author solution
 */
public class ar_pos_sales_detail1extcol extends ArrayList<ar_pos_sales_detail1ext> {
    ar_pos_sales_detail1ext data=new ar_pos_sales_detail1ext();
    String squery="";
    DbBean db=appsettinghandler.db;
    Integer docentry;

    public void insert(){
        data= new ar_pos_sales_detail1ext();
    }
    public ar_pos_sales_detail1extcol(Integer docentry){
        this.docentry=docentry;
    }

    public ar_pos_sales_detail1ext getData() {
        return data;
    }

    public void setData(ar_pos_sales_detail1ext data) {
        this.data = data;
    }
    ...
    public void initdata() throws SQLException{
        squery="call sp_ar_pos_sales_detail1_get("+this.docentry+")";
    ...
    public Boolean delete(int row) {
        ar_pos_sales_detail1ext o = this.get(row);
        try {
            return o.delete();
        } catch (CodeException ex) {
            Logger.getLogger(ar_pos_sales_detail1extcol.class.getName()).log(Level.SEVERE, null, ex);
        }
        return false;
    }
}
