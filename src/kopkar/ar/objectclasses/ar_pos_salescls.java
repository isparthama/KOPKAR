/*
 * To change this ar_pos_sales, choose Tools | Templates
 ...
 * @author mtgmis30
 */
public class ar_pos_salescls implements Serializable {
    ...
    private String payment_salary_status;
    private Double payment_discount;
    private Double payment_voucher;
    private Double payment_cash;
    private Double payment_salary;
    private Double payment_credit_card;
    private Double payment_debit_card;
    private Double total_net_sales;
    private Double payment_receipt;
    ...
    private String reffno_pos_return;
    private Double payment_pos_return;
    private Integer jumlah_tempo_angsuran;

    public ar_pos_salescls() {
    }
    ...
    public String getinvoice_sts() {
        return invoice_sts;
    }
    public void setinvoice_sts(String invoice_sts) {
        this.invoice_sts = invoice_sts;
    }
    ...
    public String getreffno_pos_return() {
        return reffno_pos_return;
    }
    public void setreffno_pos_return(String reffno_pos_return) {
        this.reffno_pos_return = reffno_pos_return;
    }
    ...
    public Integer getjumlah_tempo_angsuran() {
        return jumlah_tempo_angsuran;
    }
    public void setjumlah_tempo_angsuran(Integer jumlah_tempo_angsuran) {
        this.jumlah_tempo_angsuran = jumlah_tempo_angsuran;
    }
