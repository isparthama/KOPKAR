 ...
 * @author mtgmis30
 */
public class ar_pos_sales_detail1cls implements Serializable {
    ...
    private Double discount_percent=new Double(0);
    private Double discount_amount=new Double(0);
    private Double total_gross=new Double(0);
    private Double total_after_discount=new Double(0);
    private Double uom2=new Double(0);
    private Double uom3=new Double(0);
    private Double quantity_pcs=new Double(0);
    private Double cost_pcs=new Double(0);
    private Double price_pcs=new Double(0);
    private Double quantity_open=new Double(0);
    private Double quantity_pcs_open=new Double(0);
    ...
    public ar_pos_sales_detail1cls() {
    }
