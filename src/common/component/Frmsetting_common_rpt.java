...
import common.objectclasses.extended.setting_common_rpt_detail1ext;
import common.objectclasses.extended.setting_common_rpt_detail1extcol;
import common.objectclasses.extended.setting_common_rptext;
...
public class Frmsetting_common_rpt extends javax.swing.JInternalFrame implements NavigatorFormInt {

    private static int istatus = 0;
    private static int iformtype = 0;
    public static String CLASSNAME="Frmsetting_common_rpt";
    
    FrmMainFrame mf ;

    setting_common_rptext obj=new setting_common_rptext();
    setting_common_rpt_detail1extcol objds;
    private DefaultTableModel model;
    private setting_common_rptext objtmp;
    private browsecontroller obrowse=new browsecontroller();

    
   
    /** Creates new form Area */
    public Frmsetting_common_rpt() throws CodeException {
        initComponents();
    }
    
    public Frmsetting_common_rpt(FrmMainFrame mf) throws CodeException{
        this.mf = mf;
        initComponents();
    ...
    private void initComponents() {
        ...
        jHeader.setText(" : : Setting Report");
...
private void jtbldetailKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtbldetailKeyPressed
    ...
    switch (evt.getKeyCode()){
        ...
        case KeyEvent.VK_DELETE:
            ...
            setting_common_rpt_detail1ext o = objds.get(jtbldetail.getSelectedRow());
...
private void jbtnBrowseActionPerformed(java.awt.event.ActionEvent evt) {                                           
    obrowse.showbrowser(obrowse.setting_common_rpt, "",jtxtreportname);
    try {
        obj.initdata(jtxtreportname.getText());
        showData();
    } catch (CodeException ex) {
        Logger.getLogger(Frmsetting_common_rpt.class.getName()).log(Level.SEVERE, null, ex);
    }
}                                                                                 
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frmsetting_common_rpt().setVisible(true);
                } catch (CodeException ex) {
                    ex.printStackTrace();
                }
            }
    ...
    public void showData() throws CodeException {
        ...
        for(int i=0;i<objds.size();i++){
            ...
            setting_common_rpt_detail1ext o = objds.get(i);
            model.addRow(new Object[model.getColumnCount()]);
    ...
    private void cekdetail() {
        ...
        setting_common_rpt_detail1ext objd=new setting_common_rpt_detail1ext();
        if (row > objds.size() - 1) {
            objd = new setting_common_rpt_detail1ext();
            objd.setstatus(setting_common_rpt_detail1ext.Status_Insert);
            objds.add(objd);
            System.out.println("row inserted");
        } else {
            objd = (setting_common_rpt_detail1ext) objds.get(row);
            if (!objd.getstatus().equals(setting_common_rpt_detail1ext.Status_Insert)&&!objd.getstatus().equals(setting_common_rpt_detail1ext.Status_delete)){
                objd.setstatus(setting_common_rpt_detail1ext.Status_update);
